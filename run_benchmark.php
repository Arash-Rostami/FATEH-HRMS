...
// Option A: execute 3 queries for data (still inside a loop, but we do 1 query for counts)
foreach ($columns as $column) {
...
echo "\nOptimized Method (1 query for counts, 3 for data + eager loading):\n";
