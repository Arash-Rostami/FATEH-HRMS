...
return [
    ...
    */
    ...
    'ascii' => ':attribute فقط می‌تواند شامل کاراکترها و نمادهای تک‌بایتی باشد.',
    ...
    'doesnt_end_with' => ':attribute نباید با یکی از این موارد ختم شود: :values.',
    'doesnt_start_with' => ':attribute نباید با یکی از این موارد شروع شود: :values.',
    'email' => ':attribute باید یک آدرس ایمیل معتبر باشد.',
    'ends_with' => ':attribute باید با یکی از این موارد ختم شود: :values.',
    ...
    'hex_color' => 'فیلد :attribute باید یک رنگ معتبر با فرمت هگزادسیمال باشد.',
    ...
    'missing_if' => 'هنگامی که :other برابر :value است، فیلد :attribute باید مفقود باشد.',
    'missing_unless' => 'فیلد :attribute باید مفقود باشد مگر اینکه :other برابر :value باشد.',
    'missing_with' => 'هنگامی که :values وجود دارد، فیلد :attribute باید مفقود باشد.',
    'missing_with_all' => 'هنگامی که :values وجود دارند، فیلد :attribute باید مفقود باشد.',
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute وارد شده در یک نشت اطلاعاتی پیدا شده است. لطفاً :attribute دیگری انتخاب کنید.',
    ],
    ...
    'present_with' => 'هنگامی که :values وجود دارد، فیلد :attribute باید وجود داشته باشد.',
    'present_with_all' => 'هنگامی که :values وجود دارند، فیلد :attribute باید وجود داشته باشد.',
    ...
    'required_if_accepted' => 'هنگامی که :other پذیرفته می‌شود، فیلد :attribute الزامی است.',
