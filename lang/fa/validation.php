...
return [
    ...
    */
    ...
    'ascii'                => ':attribute باید فقط شامل کاراکترهای اسکی یک بایتی باشد.',
    ...
    'doesnt_end_with'      => ':attribute نباید با یکی از این موارد پایان یابد: :values.',
    'doesnt_start_with'    => ':attribute نباید با یکی از این موارد شروع شود: :values.',
    ...
    'missing_if'           => 'هنگامی که :other برابر :value است، فیلد :attribute نباید وجود داشته باشد.',
    'missing_unless'       => 'فیلد :attribute نباید وجود داشته باشد مگر اینکه :other برابر :value باشد.',
    'missing_with'         => 'در صورت وجود :values، فیلد :attribute نباید وجود داشته باشد.',
    'missing_with_all'     => 'در صورت وجود :values، فیلد :attribute نباید وجود داشته باشد.',
    ...
    'password'             => [
        ...
        'symbols'       => ':attribute باید شامل حداقل یک نماد (Symbol) باشد.',
        'uncompromised' => ':attribute وارد شده در یک نشت اطلاعاتی پیدا شده است. لطفا :attribute دیگری انتخاب کنید.',
    ],
    'present'              => 'فیلد :attribute باید حضور داشته باشد.',
    'present_if'           => 'هنگامی که :other برابر :value است، فیلد :attribute باید حضور داشته باشد.',
    'present_unless'       => 'فیلد :attribute باید حضور داشته باشد مگر اینکه :other برابر :value باشد.',
    'present_with'         => 'در صورت وجود :values، فیلد :attribute باید حضور داشته باشد.',
    'present_with_all'     => 'در صورت وجود :values، فیلد :attribute باید حضور داشته باشد.',
    ...
    'same'                 => ':attribute و :other باید با هم مطابقت داشته باشند.',
    'size'                 => [
    ...
    'unique'               => ':attribute از قبل انتخاب شده است.',
