...
return [
    ...
    'validation' => [
        'view' => [
            'url' => 'فرمت لینک «view» نامعتبر است.',
        ],
        ...
        'departments' => [
            'in' => 'واحدهای ذی‌نفع انتخاب شده نامعتبر است.',
        ],
        ...
        'description' => [
            ...
            'max' => 'طول متن پیشنهاد بیش از حد مجاز است.',
        ],
        'purpose' => [
            'required' => 'حداقل یک هدف باید انتخاب شود.',
            'in' => 'اهداف پیشنهاد انتخاب شده نامعتبر است.',
        ],
        'rule' => [
            'required' => 'حداقل یک اصل باید انتخاب شود.',
            'in' => 'اصول حاکم انتخاب شده نامعتبر است.',
        ],
        'attachment' => [
