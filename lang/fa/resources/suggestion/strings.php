...
return [
    ...
    'hints' => [
        ...
        'attachment'  => 'فایل پیوست مرتبط با پیشنهاد (PDF، PNG یا JPG)؛ حداکثر ۲ مگابایت.',
    ],
    ...
    'validation' => [
        ...
        'user_id' => [
            ...
            'exists'   => 'پیشنهاددهنده نامعتبر است.',
            'selected' => 'پیشنهاددهنده انتخاب‌شده معتبر نیست.',
            'invalid'   => 'پیشنهاددهنده نامعتبر است.',
        ],
    ],
