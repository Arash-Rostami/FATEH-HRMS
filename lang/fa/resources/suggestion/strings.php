...
return [
    ...
    'fields' => [
        ...
        'user_locked' => 'پیشنهاد دهنده به‌طور خودکار شما هستید و قابل تغییر نیست. برای ثبت پیشنهاد از طرف کاربر دیگر، به صفحه همان کاربر بروید (کاربران ← کاربر مورد نظر ← تب پیشنهادات) و از آنجا پیشنهاد جدید ثبت کنید.',
    ],
    ...
    'errors' => [
        'ma_restricted' => 'اعضای واحد مدیریت (MA) امکان ثبت پیشنهاد را ندارند.',
    ],
];
