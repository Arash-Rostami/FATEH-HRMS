...
return [
    ...
    'validation' => [
        'title_required' => 'عنوان پست الزامی است.',
        'title_max_length' => 'طول نباید بیشتر از :length کاراکتر باشد.',
        'body_required'  => 'محتوای پست الزامی است.',
        'body_max'       => 'محتوا نباید بیشتر از :length کاراکتر باشد.',
    ],
