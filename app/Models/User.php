...
class User extends Authenticatable implements HasAvatar
{
    ...
    public function assignedTasks(): \Illuminate\Database\Eloquent\Relations\HasMany { return $this->hasMany(Task::class, 'assigned_to'); }
    public function createdTasks(): \Illuminate\Database\Eloquent\Relations\HasMany { return $this->hasMany(Task::class, 'user_id'); }
    public function assignedTickets(): \Illuminate\Database\Eloquent\Relations\HasMany { return $this->hasMany(Ticket::class, 'assigned_to'); }
    public function requestedTickets(): \Illuminate\Database\Eloquent\Relations\HasMany { return $this->hasMany(Ticket::class, 'requester_id'); }
    public function receivedMessages(): \Illuminate\Database\Eloquent\Relations\HasMany { return $this->hasMany(Message::class, 'recipient_id'); }
    public function reads(): \Illuminate\Database\Eloquent\Relations\HasMany { return $this->hasMany(Read::class, 'user_id'); }
    public function onboardings(): \Illuminate\Database\Eloquent\Relations\HasMany { return $this->hasMany(Onboarding::class, 'user_id'); }
    public function authority(): \Illuminate\Database\Eloquent\Relations\HasOne { return $this->hasOne(Authority::class, 'user_id'); }
    public function cancelledReservations(): \Illuminate\Database\Eloquent\Relations\HasMany { return $this->hasMany(Reservation::class, 'cancelled_by_id'); }
}
