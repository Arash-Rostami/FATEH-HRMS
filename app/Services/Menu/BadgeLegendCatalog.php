...
class BadgeLegendCatalog
{
    ...
    public static function subgroups(): array
    {
        return [
            'notifications' => [
                ...
                'channels' => ['label' => 'گروه‌ها', 'icon' => 'groups'],
            ],
            'content' => [
            ...
            'tasks' => [
                ...
                'reminders' => ['label' => 'یادآوری', 'icon' => 'alarm'],
                'reminders-badge' => ['label' => 'زنگ یادآوری', 'icon' => 'notifications_active'],
            ],
        ];
    }
    ...
    protected static function all(): array
    {
        return [
            ...
            'workflow:nudge' => [
                'group' => 'tasks', 'subgroup' => 'projects', 'tone' => 'gold', 'icon' => 'conversion_path',
                'label' => 'نوبت مرحلهٔ چرخهٔ کاری',
                'lights' => 'وقتی نوبت مرحله‌ای از چرخهٔ کاری پروژه به شما برسد، یا چرخه‌ای که مالک آن هستید به پایان برسد. این مورد دات ندارد، فقط زنگوله.',
                'clears' => 'با تکمیل همان مرحله؛ صرفاً مشاهدهٔ تب «چرخهٔ کاری» خاموشش نمی‌کند.',
            ],
            'projects-controller:edge' => [
                'group' => 'tasks', 'subgroup' => 'projects', 'tone' => 'sage', 'icon' => 'group_add',
                'label' => 'کارت اعلان پروژه (دعوت/گروه بازنشده)',
                'lights' => 'با افزوده‌شدن شما به پروژه‌ای یا دعوت‌شدن به گروه پروژه‌ای که هنوز باز نکرده‌اید، کارت اعلانی پایین صفحه ظاهر می‌شود. این مورد دات ندارد، فقط کارت.',
            ...
            'channels-controller' => [
                ...
                'label' => 'دعوت یا پیام تازهٔ گروه',
                'lights' => 'با دعوت‌شدن به گروهی تازه یا رسیدن پیام تازه در گروهی که عضو آن هستید. این مورد دات ندارد، فقط زنگوله.',
                'clears' => 'با بستن زنگوله؛ دکمهٔ «مشاهده» مستقیماً شما را به همان گروه می‌برد.',
            ],
            'channels-controller:edge' => [
                'group' => 'notifications', 'subgroup' => 'channels', 'tone' => 'sage', 'icon' => 'alternate_email',
                'label' => 'کارت اعلان گروه (دعوت/منشن)',
                'lights' => 'وقتی به گروهی دعوت شوید یا کسی شما را در پیام گروه منشن کند، کارت اعلانی پایین صفحه ظاهر می‌شود. این مورد دات ندارد، فقط کارت.',
                'clears' => 'با بستن کارت (×) پنهان می‌شود؛ روی همهٔ صفحات نمایش می‌یابد.',
            ],
            'gallery-controller' => [
            ...
            'reminders-controller' => [
                'group' => 'tasks', 'subgroup' => 'reminders-badge', 'tone' => 'gold', 'icon' => 'notifications_active',
                'label' => 'یادآوری نیازمند توجه',
                'lights' => 'وقتی یادآوری فعالی تا پایان امروز سررسید داشته باشد یا سررسید آن گذشته باشد.',
                'clears' => 'با تکمیل یا حذف همان یادآوری، یا وقتی رکورد متصل به آن (وظیفه/تیکت/…) حذف موقت شود؛ صرفاً بازکردن پنجرهٔ یادآوری‌ها خاموشش نمی‌کند.',
                'surface' => 'نقطهٔ کنار آیکن زنگ یادآوری‌ها در نوار بالای صفحه.',
            ],
            'reminders-controller:due-nudge' => [
                'group' => 'tasks', 'subgroup' => 'reminders', 'tone' => 'sage', 'icon' => 'alarm',
                'label' => 'یادآوری سررسید‌شده',
                'lights' => 'یک‌بار، وقتی یادآوری فعال شما سررسید بگذرد یا همان روز فرابرسد. این مورد دات ندارد، فقط زنگوله.',
                'clears' => 'با بستن زنگوله، یا خودکار وقتی یادآوری تکمیل/حذف شود، سررسیدش تغییر کند، یا رکورد متصل به آن حذف موقت شود.',
            ],
            'reminders-controller:due-today-edge' => [
                'group' => 'tasks', 'subgroup' => 'reminders', 'tone' => 'sage', 'icon' => 'notifications',
                'label' => 'یادآوری امروز',
                'lights' => 'وقتی یادآوری فعال شما امروز سررسید داشته باشد، کارت اعلانی پایین صفحه ظاهر می‌شود. این مورد دات ندارد، فقط کارت.',
                'clears' => 'با بستن کارت (×) پنهان می‌شود؛ خودکار هم وقتی یادآوری تکمیل/حذف شود یا رکورد متصل به آن حذف موقت شود؛ روی همهٔ صفحات نمایش می‌یابد.',
            ],
        ];
    }
}
