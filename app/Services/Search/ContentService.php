    ...
    protected function resources(): array
    {
        ...
        return [
            ...
            [
                ...
                'orderBy' => 'date',
                'scope' => fn(Builder $q) => $q->where(fn(Builder $query) => $query->where('user_id', $me)
                    ->orWhereNull('user_id')
                    ->orWhere(fn(Builder $sub) => $sub->where('user_id', '!=', $me)
                        ->where('private', false)
                    )
                ),
            ...
            [
                ...
                'scope' => fn(Builder $q) => $q->where(fn(Builder $query) => $query->where('requester_id', $me)->orWhere('assigned_to', $me)
                ),
            ...
            [
                ...
                'titleField' => 'title',
                'subtitleField' => 'description',
                'scope' => fn(Builder $q) => $q->where(fn(Builder $query) => $query->where('user_id', $me)->orWhere('assigned_to', $me)
                ),
            ...
            [
                ...
                'subtitleField' => 'body',
                'scope' => fn(Builder $q) => $q->where(fn(Builder $query) => $query->where('sender_id', $me)->orWhere('recipient_id', $me)
                ),
