    ...
    protected function getSearchableItems(): Collection
    {
        return collect([
            ...
            [
                ...
                'icon' => 'person',
                'action' => 'route:profile', // Assuming route exists or handled
            ...
            [
                ...
                'icon' => 'logout',
                'action' => 'event:logout', // Or a dedicated route
        ...
        return $this->getSearchableItems()
            ->map(function ($item) use ($query) {
                ...
                foreach ($item['keywords'] as $keyword) {
                    ...
                    // Near word match (Levenshtein) - for typos
                    // Only check if query is at least 3 chars to avoid noise
                    if (strlen($query) >= 3) {
