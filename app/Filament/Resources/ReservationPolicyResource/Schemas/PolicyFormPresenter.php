...
class PolicyFormPresenter
{
    ...
    public static function allowFullDay(): Toggle
    {
        return Toggle::make('allow_full_day')
            ->validationMessages([
                'required' => __('resources/policy/strings.validation.generic.required'),
                'unique' => __('resources/policy/strings.validation.generic.unique'),
                'max' => __('resources/policy/strings.validation.generic.max'),
                'min' => __('resources/policy/strings.validation.generic.min'),
                'email' => __('resources/policy/strings.validation.generic.email'),
                'numeric' => __('resources/policy/strings.validation.generic.numeric'),
                'mimes' => __('resources/policy/strings.validation.generic.mimes'),
                'url' => __('resources/policy/strings.validation.generic.url'),
                'in' => __('resources/policy/strings.validation.generic.in'),
                'exists' => __('resources/policy/strings.validation.generic.exists')
            ])
