...
enum FavoriteColor: string implements HasLabel, HasColor
{
    ...
    public function getLabel(): ?string
    {
        return match ($this) {
            ...
            self::VeryLightBlue => 'Very Light Blue',
            self::TealBlue => 'Teal Blue',
            self::Teal => 'Teal',
            ...
            self::Red => 'Red',
            self::Brown => 'Brown',
            self::TailwindRed => 'Tailwind Red',
            self::TailwindBlue => 'Tailwind Blue',
            self::TailwindEmerald => 'Tailwind Emerald',
            self::TailwindAmber => 'Tailwind Amber',
            self::Black => 'Black',
            self::White => 'White',
            self::TailwindViolet => 'Tailwind Violet',
            self::TailwindPink => 'Tailwind Pink',
            self::TailwindSlate => 'Tailwind Slate',
            self::TailwindTeal => 'Tailwind Teal',
        };
    }
