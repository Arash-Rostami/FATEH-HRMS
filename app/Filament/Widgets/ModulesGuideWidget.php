...
class ModulesGuideWidget extends Widget
{
    ...
    protected function moduleFilamentIcons(): array
    {
        return [
            ...
            'authority' => ['filament_icon' => 'heroicon-o-clipboard-document-check'],
            'reminder' => ['filament_icon' => 'heroicon-o-clock'],
            'ai-assistant' => ['filament_icon' => 'heroicon-o-cpu-chip'],
    ...
    protected function moduleMeta(): array
    {
        return [
            ...
            'channel' => ['major_category' => 'محتوا و ارتباطات', 'admin_tip' => 'وضعیت گروه‌ها و پیام‌ها را از طریق Relation Managers مدیریت کنید. مالکیت و اعضای هر گروه با استفاده از Attach/Detach Actions به‌سرعت قابل تنظیم است.'],
            ...
            'projects' => ['major_category' => 'عملیات و منابع', 'admin_tip' => 'پروژه‌ها را با مالک و اعضای مشخص و دپارتمان‌های مخاطب تعریف کنید. از Relation Managers برای پایش وظایف و گروه گفتگوی اختصاصی هر پروژه استفاده نمایید و پروژه‌های پایان‌یافته را بایگانی کنید.'],
            ...
            'authority' => ['major_category' => 'سیستم‌ها و ابزارها', 'admin_tip' => 'شرح وظایف، مسئولان و موارد تفویض اختیار واحدها را دوره‌ای بازبینی و تکمیل کنید. حالت تمرکز (Focus) برای پین‌کردن یک ردیف خاص و باز/بسته‌کردن یکجای همه ردیف‌ها در دسترس است.'],
            ...
            'reminder' => ['major_category' => 'سیستم‌ها و ابزارها', 'admin_tip' => 'این ماژول از طریق پنل ادمین قابل پیکربندی نیست؛ یادآورها داده شخصی هر کاربر هستند و اعلان‌های سررسید و تأخیر از مسیر سیستم نوتیفیکیشن ارسال می‌شوند.'],
            ...
            'ai-assistant' => ['major_category' => 'سیستم‌ها و ابزارها', 'admin_tip' => 'این ماژول صرفاً نمایشی است و منبع مستقلی در پنل ادمین ندارد. برای فعال‌سازی یا محدودسازی دسترسی هر سازمان، کلید ai_assistant را در config/tenants.php ویرایش کنید.'],
