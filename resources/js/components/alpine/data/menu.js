export default function menu() {
    return {
        ...
        items: [
            ...
            {id: 'profile-controller', href: '/profile?activeTab=info', icon: 'person', title: 'پروفایل', sub: 'حساب و اطلاعات'},
            {id: 'onboarding-controller', href: '/profile?activeTab=onboarding', icon: 'apartment', title: 'آنبوردینگ', sub: 'آشنایی با شرکت'},
            ...
            {id: 'documents-controller', href: '/profile?activeTab=documents', icon: 'folder_open', title: 'مدارک و اسناد', sub: 'آپلود و دانلود'},
            {id: 'credentials-controller', href: '/profile?activeTab=credentials', icon: 'verified_user', title: 'دسترس', sub: 'مجوزها و رمزها'},
