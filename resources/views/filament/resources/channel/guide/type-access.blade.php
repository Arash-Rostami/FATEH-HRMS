@php
    $types = [
        [
            ...
            'hint' => 'هر کاربری می‌تواند از زبانهٔ «کاوش» در پنل کاربری آن را ببیند و با یک کلیک عضو شود. برای پیوستن به گروه عمومی نیازی به دعوت نیست — عضویت باز است.',
        ],
        [
            'icon' => 'lock',
            'label' => 'خصوصی',
            ...
            'hint' => 'در فهرست «کاوش» ظاهر نمی‌شود و کاربر نمی‌تواند خودش عضو شود. تنها راه عضویت، دعوت‌شدن توسط مالک گروه از «مدیریت اعضا» است. عضو دعوت‌شده تا وقتی وارد گروه نشود، یک نقطهٔ «جدید» در نوار کناری می‌گیرد.',
        ],
    ];
@endphp
...
<div class="flex flex-col gap-5" dir="rtl">
    ...
    <div class="flex items-center gap-3 px-1">
        ...
        <p class="text-[14px] font-black text-[var(--md-sys-color-on-surface)]">دو نوع گروه — عمومی و خصوصی — تفاوت در نحوهٔ عضویت</p>
    </div>
    <p class="text-[12.5px] text-[var(--md-sys-color-on-surface-variant)] leading-7 font-medium px-1">
        نوع گروه (<code class="px-1.5 py-0.5 rounded-md bg-[var(--md-sys-color-secondary-container)] text-[var(--md-sys-color-on-secondary-container)] font-mono text-[11px]">type</code>) فقط نحوهٔ عضویت را تعیین می‌کند؛ روی محتوای پیام‌ها یا دسترسی اعضای فعلی اثری ندارد. رنگ و آیکون ستون «نوع» در جدول همین‌جا تعریف شده است. این فیلد در زمان ویرایش توسط ادمین قابل تغییر است.
    </p>
    ...
    <div class="flex flex-col rounded-2xl bg-[var(--md-sys-color-surface)] shadow-md shadow-[var(--md-sys-color-shadow)]/5 overflow-hidden animate-slide-up-fade">
        <div class="px-5 py-3.5 bg-[var(--md-sys-color-primary-container)] flex items-center gap-2">
            ...
            <p class="text-[13px] font-black text-[var(--md-sys-color-on-primary-container)]">دو نوع گروه</p>
        </div>
    ...
    <div class="flex flex-col rounded-2xl bg-[var(--md-sys-color-surface)] shadow-md shadow-[var(--md-sys-color-shadow)]/5 overflow-hidden animate-slide-up-fade">
        ...
        <div class="divide-y divide-[var(--md-sys-color-outline-variant)]">
            ...
            <div class="flex items-start gap-4 p-5 hover:bg-[var(--md-sys-color-surface-container)] transition-colors duration-300">
                ...
                <div class="flex-1 flex flex-col gap-1.5">
                    ...
                    <p class="text-[12px] text-[var(--md-sys-color-on-surface-variant)] leading-6 font-medium">با ورود به گروه، <code class="px-1.5 py-0.5 rounded-md bg-[var(--md-sys-color-secondary-container)] text-[var(--md-sys-color-on-secondary-container)] font-mono text-[11px]">entered_at</code> پر می‌شود و نقطهٔ «جدید» از بین می‌رود. از این پس پیام‌های جدید بر اساس <code class="px-1.5 py-0.5 rounded-md bg-[var(--md-sys-color-secondary-container)] text-[var(--md-sys-color-on-secondary-container)] font-mono text-[11px]">last_read_message_id</code> خوانده‌نشده محاسبه می‌شوند. در جدول اعضای گروه (روی صفحهٔ ویرایش) ستون «تاریخ ورود» این وضعیت را نشان می‌دهد.</p>
                </div>
            </div>
        </div>
        <div class="px-5 py-3.5 bg-[var(--md-sys-color-surface-container-lowest)] border-t border-[var(--md-sys-color-outline-variant)]">
            <p class="text-[11px] font-bold text-[var(--md-sys-color-on-surface-variant)] flex items-center gap-2">
                ...
                مالک گروه خودکار عضو می‌شود و <code class="px-1.5 py-0.5 rounded-md font-mono text-[11px] bg-[var(--md-sys-color-secondary-container)] text-[var(--md-sys-color-on-secondary-container)]">entered_at</code> او از همان لحظهٔ ساخت پر است — او هرگز «دعوت‌شده» نمی‌ماند.
            </p>
        </div>
    </div>
</div>