@php
    $panels = [
        ...
        [
            'icon' => 'event_seat',
            'label' => 'رزروها در تقویم',
            'hint' => 'همهٔ رزروهای فعال کاربر در هر نوع منبع (صندلی، اسپات، خودرو، جلسه و...) به‌صورت خصوصی در تقویم او نمایش داده می‌شوند. رزرو جلسه به‌صورت خودکار یک رویداد خصوصی می‌سازد و با طرف مقابل اشتراک می‌گذارد؛ سایر رزروها به‌صورت بلوک یا نوار فقط‌خواندنی (بدون ساخت رویداد) نشان داده می‌شوند. هیچ‌کدام از تقویم ویرایش یا حذف نمی‌شوند — برای تغییر یا لغو باید به تب «رزرو» رفت.',
        ],
        [
            'icon' => 'alarm',
