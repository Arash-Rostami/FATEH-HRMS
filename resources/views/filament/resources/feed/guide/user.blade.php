@php
    $panels = [
        ...
        [
            ...
            'hint' => 'دکمهٔ تقویم بالای تایم‌لاین، ماه‌های موجود (مثل «اردیبهشت ۱۴۰۴») را از تاریخ انتشار می‌سازد؛ انتخاب یک ماه، فقط فیدهای همان ماه را نشان می‌دهد و «همه ماه‌ها» فیلتر را پاک می‌کند.',
        ],
        [
            'icon' => 'ballot',
        ...
        [
            'icon' => 'dashboard',
            'label' => 'نمای مجله',
            'hint' => 'کنار تایم‌لاین، دکمهٔ نمای مجله فیدها را به‌صورت کارت‌های فشردهٔ ستونی نشان می‌دهد؛ نوار رنگی بالای هر کارت دسته را می‌رساند و شمارشِ نظر/واکنش، نشانِ نظرسنجی و زمانِ نسبی در پایین کارت می‌آید. کلیک روی کارت، همان فید را در تایم‌لاین باز می‌کند. دکمه‌های چپ/راست فقط در تایم‌لاین ظاهر می‌شوند و انتخاب کاربر در نشست ذخیره می‌شود.',
        ],
    ];
@endphp
