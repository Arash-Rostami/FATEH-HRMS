@php
    $formTabs = [
        [
            'icon' => 'assignment',
            'label' => 'زبانهٔ اصلی',
            'hint' => 'ایجادکننده، مسئول انجام، وضعیت (پیش‌فرض: انجام‌نشده) + ضرب‌الاجل (تاریخ شمسی از PersianDateFieldService + ساعت، پیش‌فرض ' . convertToPersian('17') . ':۰۰) + عنوان و توضیحات.',
        ],
        [
            'icon' => 'bar_chart',
            'label' => 'زبانهٔ اطلاعات سازمانی (detail)',
            'hint' => 'واحد، بخش (گزینه‌ها از همان واحد می‌آید — تغییر واحد، بخش را ریست می‌کند)، پروژه، طرح، مبدأ اقدام، همکاران (چندانتخابی از پرسنل فعال)، مسئول ردگیری، وضعیت فرآیندی (تمدید/توقف/تکمیل) و پیوست‌ها. این زبانه روی رابطهٔ <code class="px-1.5 py-0.5 rounded-md font-mono text-[11px] bg-[var(--md-sys-color-secondary-container)] text-[var(--md-sys-color-on-secondary-container)]">detail</code> ذخیره می‌شود.',
        ],
    ];
    ...
    $ops = [
        ...
        [
            'icon' => 'edit',
            'label' => 'ویرایش',
            'hint' => 'فرم با دو زبانه (اصلی + اطلاعات سازمانی). ضرب‌الاجل شمسی است؛ ساعتِ جداگانه در کنار تاریخ ذخیره می‌شود. تغییر واحد، گزینه‌های بخش را خالی می‌کند.',
        ],
        [
            'icon' => 'delete',
            'label' => 'حذف نرم',
        ...
        [
            'icon' => 'download',
            'label' => 'خروجی اکسل',
            'hint' => 'از bulk actions روی ردیف‌های انتخاب‌شده (TaskExporter). ستون‌ها: شناسه، عنوان، توضیحات، وضعیت (برچسب enum)، ایجادکننده، مسئول، ضرب‌الاجل، تاریخ ایجاد/حذف/آرشیو — همگی با toJalaliSmart شمسی‌سازی می‌شوند.',
        ],
    ];
