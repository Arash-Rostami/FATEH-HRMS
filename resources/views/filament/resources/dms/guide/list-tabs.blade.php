@php
    ...
    $filters = [
        ['icon' => 'rule', 'label' => 'فیلتر نوع (اسناد/سوابق)', 'hint' => 'یک <code class="px-1.5 py-0.5 rounded-md font-mono text-[11px] bg-[var(--md-sys-color-secondary-container)] text-[var(--md-sys-color-on-secondary-container)]">TernaryFilter</code> روی فیلد <code class="px-1.5 py-0.5 rounded-md font-mono text-[11px] bg-[var(--md-sys-color-secondary-container)] text-[var(--md-sys-color-on-secondary-container)]">type</code>: بله/خیر/همه — یعنی فقط اسناد، فقط سوابق، یا هر دو.'],
