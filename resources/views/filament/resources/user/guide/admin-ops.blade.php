@php
    $ops = [
        ...
        [
            ...
            'hint' => 'اول گیرنده را انتخاب می‌کنید: «مدیر این کاربر» (پیش‌فرض؛ مدیرِ حل‌شدهٔ همین کاربر) یا «کاربر دیگر» که با انتخاب آن، فهرست کاربران فعال نمایان می‌شود. اعلان حاوی گزارش برای گیرنده ارسال می‌شود.',
        ],
    ];
    $rms = [
        ...
        ['label' => 'رزروها', 'icon' => 'event', 'note' => 'رزروهای منابع این کاربر — مشاهده در پنجره، ویرایش از طریق صفحهٔ کامل رزرو، لغو و آزادسازی.'],
