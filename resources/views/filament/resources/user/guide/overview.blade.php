@php
    $enums = [
        ...
        [
            ...
            'label' => 'حضور (presence)',
            'hint' => 'فیلد جداگانه از وضعیت — بر فیلترهای حضور و غیاب و گزارش‌های سازمانی تأثیر می‌گذارد. به‌صورت enum ذخیره می‌شود و در ستون جدول و اینفولیست به‌صورت badge با رنگ خودش نمایش داده می‌شود. وقتی کاربر «حالت تمرکز» را از پنل خودش فعال کرده باشد، یک آیکون ساعت کنار badge با تولتیپ «متمرکز تا HH:MM» نمایش داده می‌شود — این فقط نمایشی است و از پنل ادمین قابل ویرایش یا پاک‌سازی نیست.',
        ],
    ];
    $json = [
        [
