@php
    $fields = [
        ...
        [
            ...
            'tag' => 'اختیاری',
            'hint' => 'واحدِ موضوعِ گزارش — یعنی گزارش دربارهٔ کدام واحد است، نه اینکه چه کسی مجاز به دیدنش باشد (آن نقش را فیلد «دسترسی واحدها» زیر بازی می‌کند، کاملاً مستقل از این فیلد). کاربران در زبانهٔ گزارشات می‌توانند بر اساس همین واحد فیلتر کنند. کلید اتصال «کد واحد» است (نه آیدی عددی).',
        ],
        [
            'icon' => 'person',
            'label' => 'کاربر (user_id)',
