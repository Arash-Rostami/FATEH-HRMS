@php
    $ops = [
        [
            'icon' => 'visibility',
            'label' => 'مشاهده',
            'hint' => 'اینفولیست با هشت زبانه: «اطلاعات» (کاربر، فعال، تاریخ‌های شمسی) به‌علاوه یک زبانه برای هر بخش محتوا (خوش‌آمد، مأموریت، چشم‌انداز، برنامه، ویدیوها، راهنماها، اضافی) — آینهٔ زبانه‌های فرم. فایل‌های ویدیو و راهنما در اینفولیست قابل دانلود/پخش هستند.',
        ],
        [
            'icon' => 'edit',
            'label' => 'ویرایش',
