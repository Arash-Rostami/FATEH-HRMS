@php
    $panels = [
        ...
        [
            ...
            'hint' => 'هر پرسش، چه در نمای کارت و چه در نمای فهرست، یک ردیف آکاردئونی است — با کلیک روی آن، پاسخ با یک ترنزیشن محو/جابه‌جایی (fade + translate) باز می‌شود؛ کلیک دوباره آن را می‌بندد. لینک‌های داخل پاسخ خودکار در زبانهٔ جدید (target=_blank) باز می‌شوند. آیکونِ expand_more در انتهای ردیف با باز شدن ۱۸۰ درجه می‌چرخد.',
        ],
        [
