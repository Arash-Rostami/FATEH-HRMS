@php
    $panels = [
        ...
        [
            'icon' => 'grid_view',
            'label' => 'نمای دیوار (masonry)',
            'hint' => 'کنار تایم‌لاین، دکمهٔ نمای دیوار گالری‌ها را به‌صورت شبکهٔ ستونی فشرده نشان می‌دهد؛ زیر هر تصویر عنوان و تاریخ، نشان «+N» برای تصاویر اضافی و با رفتنِ موس واحد سازمانی روی تصویر می‌آید. کلیک روی تصویر لایت‌باکس را باز می‌کند. دکمه‌های چپ/راست فقط در تایم‌لاین ظاهر می‌شوند و انتخاب کاربر در نشست ذخیره می‌شود.',
        ],
    ];
