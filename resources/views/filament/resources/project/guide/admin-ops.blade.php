<div class="flex flex-col gap-5" dir="rtl">
    ...
    <p class="text-[12.5px] text-[var(--md-sys-color-on-surface-variant)] leading-7 font-medium px-1">
        حذف نرم (Delete) یک پروژه آن را از فهرست‌ها پنهان می‌کند اما وظایف و گروه آن دست‌نخورده باقی می‌مانند. پروژه‌های حذف‌شده پس از ۳۰ روز به‌صورت خودکار حذف کامل می‌شوند — در این لحظه وظایف مرتبط فقط از پروژه جدا می‌شوند، نه حذف.
    </p>
    <p class="text-[12.5px] text-[var(--md-sys-color-on-surface-variant)] leading-7 font-medium px-1">
    ...
    <div class="flex flex-col rounded-2xl bg-[var(--md-sys-color-surface)] shadow-md shadow-[var(--md-sys-color-shadow)]/5 overflow-hidden animate-slide-up-fade">
        ...
        <div class="divide-y divide-[var(--md-sys-color-outline-variant)]">
            <p class="px-4 pt-3 text-[12px] text-[var(--md-sys-color-on-surface-variant)]">هر تغییر در این تنظیمات — از هر پنلی — به‌طور خودکار یک ردیف «تغییر تنظیمات پروژه» در فعالیت‌های پروژه (پنل کاربر) ثبت می‌کند.</p>
            @foreach([
                ...
                ['icon' => 'library_add', 'label' => 'تنظیمات آزاد (extraSettings)', 'hint' => 'کلید/مقدارهای دلخواهِ مالک پروژه علاوه بر چهار تنظیم بالا — همان چیزی که در پنل کاربری می‌بیند و ویرایش می‌کند؛ اینجا دوسویه است و حذف یک ردیف همان کلید را از پروژه برمی‌دارد. ردیف با کلید یا مقدار خالی نادیده گرفته می‌شود و کلید هم‌نام با تنظیمات اصلی پذیرفته نمی‌شود.'],
            ] as $s)
