@php
    $fields = [
        ...
        [
            ...
            'tag' => 'رسانه',
            'hint' => 'هر دو اجباری‌اند. تصویر بنر (حداکثر ۱ مگابایت، پوشهٔ link/image) روی کارت کاربر می‌نشیند؛ آیکون (حداکثر ۵۱۲ کیلوبایت، پوشهٔ link/icon) زمانی نشان داده می‌شود که تصویر بنر وجود نداشته باشد.',
        ],
        [
            'icon' => 'badge',
            'label' => 'توضیح آیکون (icon_description)',
            'tag' => 'نکتهٔ پنهان',
            'hint' => 'این فیلد فقط متن جایگزین (alt) نیست — در پنل کاربری، وقتی تصویر بنر نباشد، مقدار این فیلد به‌عنوان نام لایگچرِ Material Symbols رندر می‌شود (مثل link یا open_in_new). نام‌های نامعتبر به‌صورت متن خام نشان داده می‌شوند؛ از نام‌های واقعی استفاده کنید.',
        ],
    ];
@endphp
