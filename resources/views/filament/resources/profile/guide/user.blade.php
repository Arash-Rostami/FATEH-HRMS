@php
    ...
    $header = [
        ...
        ['icon' => 'cake', 'label' => 'تولد و سالگرد کاری در پنل کاربر', 'hint' => 'اگر «تاریخ تولد» یا «تاریخ استخدام» دقیقاً با امروز مطابقت داشته باشد (بدون توجه به سال)، آن کارمند در نوار «مناسبت‌های امروز» صفحهٔ وضعیت همکاران نمایش داده می‌شود، در پیام‌رسان داخلی کنار نام او در فهرست مخاطبان یک نشان کوچک تپنده ظاهر می‌شود، و در آمار خوش‌آمدگویی پیام‌رسان (کنار «همکاران»، «آنلاین»، «خوانده‌نشده») یک عدد «رویدادها» اضافه می‌شود. کارمندان با وضعیت استخدام «پایان‌یافته» و کاربران نوع «مهمان» از این نمایش مستثنا هستند.'],
    ];
@endphp
