@php
    $statuses = [
        ...
        [
            ...
            'hint' => 'ادمین منبع را زودتر از موعد آزاد کرده (دکمهٔ «آزادسازی»). رزرو از حالت فعال خارج می‌شود ولی در سوابق می‌ماند. کاربر دیگر نمی‌تواند آن را لغو کند، ولی هنوز علیه سقف ماهانه‌اش می‌شمارد.',
        ],
        [
            'icon' => 'cancel',
