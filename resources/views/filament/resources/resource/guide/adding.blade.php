@php
    $fields = [
        ...
        [
            ...
            'label' => 'نوع',
            'tag' => 'الزامی',
            'hint' => 'میز کار / پارکینگ / خودرو / ملاقات یا هر نوع دیگری که با دکمهٔ «+» کنار همین فیلد ساخته‌اید. به‌محض تغییر نوع، فیلدهای فرادادهٔ مربوط به همان نوع ظاهر یا پنهان می‌شوند؛ نوع‌های تازه‌ساخته فقط یادداشت و مشخصات دلخواه را دارند.',
        ],
        [
            'icon' => 'toggle_on',
            'label' => 'وضعیت',
    ...
    $metadata = [
        ...
        [
            ...
            'label' => 'واحد',
            'types' => 'میز کار',
            'hint' => 'شماره یا نام واحد/میز. فقط برای صندلی.',
        ],
        [
            'icon' => 'credit_card',
            'label' => 'شماره کارت',
            'types' => 'پارکینگ',
            'hint' => 'شماره کارت پارکینگ اختصاص‌یافته. فقط برای پارکینگ.',
        ],
        [
            'icon' => 'call',
            'label' => 'داخلی',
        ...
        [
            ...
            'types' => 'همهٔ نوع‌ها',
            'hint' => 'محدودیت روزهای هفتهٔ اختصاصی این منبع؛ محدودتر از سیاست کلی نوع منبع عمل می‌کند، آن را نقض نمی‌کند. اگر خالی بماند فقط سیاست کلی اعمال می‌شود.',
        ],
        [
            'icon' => 'schedule',
            'label' => 'بازهٔ ساعتی',
            'types' => 'فقط نوع‌های ساعتی (مثلاً ملاقات)',
            'hint' => 'ساعت شروع/پایان در دسترس بودن این منبع مشخص. برای نوع‌های تمام‌روز (میز کار/پارکینگ/خودرو) این فیلد اصلاً نمایش داده نمی‌شود، چون رزرو آن‌ها همیشه کل روز است و ساعتی برای محدود کردن وجود ندارد.',
        ],
        [
            'icon' => 'sticky_note_2',
            'label' => 'یادداشت',
            'types' => 'همهٔ نوع‌ها',
            'hint' => 'توضیح کوتاه و دلخواه (تا ۱۰۰۰ نویسه). در صفحهٔ ویرایش منبع، جزئیات، و کارت رزرو (به‌صورت برجسته) نمایش داده می‌شود.',
        ],
        [
            'icon' => 'tune',
            'label' => 'مشخصات دلخواه',
            'types' => 'همهٔ نوع‌ها',
            'hint' => 'ردیف‌های کلید/مقدار دلخواه برای اطلاعات نمایشی اضافه؛ صرفاً جنبهٔ اطلاعاتی دارند، در اعتبارسنجی رزرو نقشی ندارند.',
        ],
    ];
@endphp
...
<div class="flex flex-col gap-5" dir="rtl">
    ...
    <p class="text-[12.5px] text-[var(--md-sys-color-on-surface-variant)] leading-7 font-medium px-1">
        از دکمهٔ «ایجاد منبع» یک فرم سه‌بخشی باز می‌شود: بخش اصلی (نام/نوع/وضعیت)، بخش فراداده (طبقه/واحد/شماره کارت/داخلی/ظرفیت/روزهای در دسترس/بازهٔ ساعتی/یادداشت/مشخصات دلخواه)، و بخش تصویر. فقط نام و نوع و وضعیت الزامی‌اند؛ بقیه اختیاری. نوعی که انتخاب می‌کنید تعیین می‌کند کدام فیلدهای فراداده نمایش داده شوند؛ یادداشت و مشخصات دلخواه برای همهٔ نوع‌ها همیشه در دسترس‌اند.
    </p>
    ...
    <div class="flex flex-col rounded-2xl bg-[var(--md-sys-color-surface)] shadow-md shadow-[var(--md-sys-color-shadow)]/5 overflow-hidden animate-slide-up-fade">
        ...
        <div class="px-5 py-3.5 bg-[var(--md-sys-color-surface-container-lowest)] border-t border-[var(--md-sys-color-outline-variant)]">
            <p class="text-[11px] font-bold text-[var(--md-sys-color-on-surface-variant)] flex items-center gap-2">
                ...
                خلاصهٔ فراداده بر نوع: میز کار ← طبقه + واحد + داخلی + روزهای در دسترس · پارکینگ ← طبقه + شماره کارت + روزهای در دسترس · خودرو ← ظرفیت + روزهای در دسترس · ملاقات ← داخلی + ظرفیت + روزهای در دسترس + بازهٔ ساعتی · نوع‌های تازه‌ساخته ← فقط روزهای در دسترس. یادداشت و مشخصات دلخواه برای همه.
            </p>
        </div>
    </div>
</div>