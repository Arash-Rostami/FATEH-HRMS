...
<div class="flex min-h-screen w-full flex-col lg:flex-row relative">
    ...
    <div class="relative hidden lg:block lg:w-[40%] h-full min-h-screen overflow-hidden order-1 group">
        ...
        <div class="absolute bottom-0 right-0 p-16 z-20 w-full bg-gradient-to-t from-[var(--md-sys-color-background)]/95 via-[var(--md-sys-color-surface-container)]/80 to-transparent">
            <div class="max-w-2xl transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 delay-100">
                ...
                <h1 class="text-5xl font-black leading-tight text-[var(--md-sys-color-on-surface)] mb-4 drop-shadow-2xl">
                    اینتـرا
                    <br/>
                    <span class="text-transparent bg-clip-text bg-gradient-to-l from-[var(--md-sys-color-primary)] to-[var(--md-sys-color-on-surface-variant)]">خـانه دیجیتـال مـا </span>
                </h1>
                <h3 class="text-[var(--md-sys-color-on-surface-variant)] text-lg max-w-lg leading-relaxed shadow-black drop-shadow-md">
                     ابـزاری کـه شمـا در دفتـر کـار به آن نیـاز داریـد
                </h3>
            </div>
        </div>
