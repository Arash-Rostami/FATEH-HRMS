...
@section('heading', $heading ?? 'خطای موقت سیستمی')

@section('message', $message ?? 'متاسفانه در پردازش درخواست شما مشکلی به وجود آمده است. تیم فنی ما از این موضوع مطلع شده و در حال بررسی می‌باشد.')
