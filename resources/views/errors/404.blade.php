    ...
    <div class="min-h-screen relative grid place-items-center p-4 md:p-8 overflow-hidden" dir="rtl"
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div class="absolute top-[60%] -left-[10%] w-[40vw] h-[40vw] max-w-[500px] max-h-[500px] rounded-full blur-[80px] opacity-30 transition-colors duration-700"
                 style="background-color: color-mix(in srgb, var(--md-sys-color-tertiary) 30%, transparent);"></div>
        </div>
        ...
        <div class="relative w-full max-w-3xl z-10 flex flex-col rounded-[2.5rem] glass-panel transition-all duration-500 overflow-hidden"
            ...
            <div class="h-2 w-full"
                 style="background: linear-gradient(90deg, var(--md-sys-color-primary), color-mix(in srgb, var(--md-sys-color-primary) 40%, var(--md-sys-color-tertiary)));"></div>
            ...
            <div class="p-8 md:p-14 lg:p-16 flex flex-col items-center text-center">
                ...
                <div class="relative flex items-center justify-center w-24 h-24 md:w-28 md:h-28 rounded-[2rem] mb-12 group transition-all duration-500 hover:scale-[1.15] hover:rotate-6 cursor-pointer z-20">
                    <div class="absolute inset-0 rounded-[2rem] animate-ping opacity-80"
                         style="background-color: var(--md-sys-color-primary-container); animation-duration: 1.2s;"></div>
                    <div class="absolute inset-0 rounded-[2rem] animate-ping opacity-50"
                         style="background-color: var(--md-sys-color-primary); animation-duration: 2s; animation-delay: 0.4s;"></div>
                    <div class="absolute inset-0 rounded-[2rem] animate-ping opacity-30"
                         style="background-color: var(--md-sys-color-tertiary); animation-duration: 2.8s; animation-delay: 0.8s;"></div>
                    ...
                    <div class="absolute -inset-6 rounded-full blur-3xl opacity-30 animate-pulse group-hover:opacity-70 transition-opacity duration-500"
                         style="background-color: var(--md-sys-color-primary);"></div>
                    ...
                    <div class="absolute inset-0 rounded-[2rem] overflow-hidden backdrop-blur-md transition-all duration-500 group-hover:shadow-[0_0_40px_-5px]"
                         style="background: radial-gradient(circle at top left, var(--md-sys-color-primary-container), transparent); border: 2px solid color-mix(in srgb, var(--md-sys-color-primary) 40%, transparent); color: var(--md-sys-color-primary);">
                        <div class="absolute inset-[-100%] opacity-0 group-hover:opacity-40 group-hover:animate-[spin_2s_linear_infinite] transition-opacity duration-300"
                             style="background: conic-gradient(from 0deg, transparent, var(--md-sys-color-primary), transparent, var(--md-sys-color-tertiary), transparent);"></div>
                    </div>

                    <span class="material-symbols-rounded font-fill !text-5xl md:!text-7xl relative z-10 animate-[bounce_3s_infinite] group-hover:animate-none group-hover:scale-125 group-hover:-rotate-12 transition-all duration-300 text-white">
                        travel_explore
                    </span>
                </div>
                ...
                <h1 class="text-8xl md:text-9xl font-black tracking-tighter mb-4 select-none"
                    style="background: linear-gradient(135deg, var(--md-sys-color-primary) 0%, var(--md-sys-color-on-surface) 100%);
                ...
                <p class="text-base md:text-lg max-w-xl mx-auto mb-10 leading-relaxed font-medium"
                   style="color: var(--md-sys-color-on-surface-variant);">
                    متأسفانه صفحه‌ای که به دنبال آن هستید وجود ندارد، نام آن تغییر کرده، یا به طور موقت از دسترس خارج شده است.
                </p>
