...
@section('heading', 'سیستم در حال بروزرسانی')

@section('message', 'سیستم در حال حاضر برای انجام بروزرسانی و بهبود عملکرد از دسترس خارج است. لطفاً دقایقی دیگر مراجعه فرمایید.')
