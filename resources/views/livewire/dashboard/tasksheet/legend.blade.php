@php
    ...
    $sections = [
        ...
        'sharing' => [
            ...
            'rows' => [
                ['icon' => 'forward_to_inbox', 'color' => 'primary', 'label' => 'اشتراک‌گذاری با مدیر یا کاربر دیگر', 'text' => 'دکمهٔ اشتراک‌گذاری ابتدا گیرنده را می‌پرسد: «مدیر این کاربر» (پیش‌فرض) یا «کاربر دیگر» که فهرست کاربران فعال را نشان می‌دهد. سپس لینک امضاشدهٔ گزارش برای گیرنده ساخته و در کارتابل او اعلان می‌گذارد؛ این لینک تا ۱۴ روز معتبر است و پس از آن دیگر باز نمی‌شود.'],
