<div dir="rtl"
    ...
    <div class="max-w-[88rem] mx-auto page-wrapper">
        ...
        <div
            class="flex flex-col md:flex-row flex-1 min-h-0 overflow-x-auto gap-3 md:gap-4 pb-2 pt-2 snap-x snap-mandatory md:snap-none scroll-px-4 md:scroll-px-0">
            @foreach($columns as $column)
                <div
                    class="snap-center shrink-0 w-full sm:w-[calc(100%-2rem)] md:w-1/3 md:flex-1 min-w-[280px] sm:min-w-[320px] md:min-w-[350px] max-w-full md:max-w-md h-full">
