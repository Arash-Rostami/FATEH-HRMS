@php
    ...
    $noteGroups = [
        ...
        'personal' => [
            ...
            'icon' => 'tune',
            'notes' => [
                'با بردن نشانگر روی هر ردیف تیکت، گوشهٔ چپ ستون «اقدام» یک دکمهٔ «پالت» ظاهر می‌شود؛ با آن می‌توانید تیکت را رنگ‌آمیزی کنید تا کل پس‌زمینهٔ ردیف همان رنگ را بگیرد و در فهرست سریع‌تر پیدا شود (مثل کارت‌های تسک‌بورد). رنگ انتخابی فقط در مرورگر خودتان ذخیره می‌شود و روی دادهٔ تیکت اثری ندارد.',
                'کنار همان دکمهٔ پالت، یک آیکون زنگ یادآوری هم هست که فقط با نگه‌داشتن نشانگر روی ردیف نمایان می‌شود؛ اگر برای آن تیکت یادآوری تنظیم کرده باشید، همیشه با رنگ اصلی برنامه نمایان می‌ماند و با کلیک، همان یادآوری موجود برای ویرایش باز می‌شود.',
