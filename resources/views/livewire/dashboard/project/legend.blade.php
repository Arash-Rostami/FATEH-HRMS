    ...
    $sections = [
        'workspace' => [
            ...
            'rows' => [
                ...
                ['icon' => 'push_pin', 'color' => 'tertiary', 'label' => 'سنجاق، بی‌صدا، رنگ‌آمیزی و یادآوری پروژه‌ها', 'text' => 'با نگه‌داشتن اشاره‌گر روی هر پروژه در فهرست کنار، سنجاق‌کردن، بی‌صداکردن اعلان، رنگ‌آمیزی و یک آیکون زنگ یادآوری ظاهر می‌شود؛ اولی سه‌تا فقط در همین مرورگر ذخیره می‌شوند، ولی یادآوری برای کل همان پروژه ثبت می‌شود (نه یک وظیفهٔ خاص) و اگر تنظیم شده باشد همیشه با رنگ اصلی برنامه نمایان می‌ماند.'],
        ...
        'comms' => [
            'intro' => 'سه سطح گفت‌وگوی جدا در این محصول: «فعالیت‌ها و نظرات» سابقهٔ رسمی پروژه (رویداد سیستمی + نظر باز) را برای همهٔ اعضا نگه می‌دارد؛ «چت زندهٔ تیم» همان گروه واقعی پروژه در ماژول «گروه‌ها» برای پیام‌رسانی آنی همهٔ اعضاست؛ «گفتگوی وظیفه» (داخل خودِ کارت در برد وظایف) خصوصی و محدود به ایجادکننده، مسئول انجام و همکاران همان یک وظیفه است.',
            'rows' => [
                ['icon' => 'forum', 'color' => 'primary', 'label' => 'چت زندهٔ تیم همان گروه واقعی است', 'text' => 'برای هر پروژه یک گروه واقعی ساخته می‌شود؛ برای امکانات کامل‌تر دکمهٔ رنگیِ کنار برگه‌ها را بزنید تا گروه کامل در تب جدید باز شود.'],
