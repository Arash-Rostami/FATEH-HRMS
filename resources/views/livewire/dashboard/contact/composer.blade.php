<footer
    class="flex-shrink-0 border-t bg-[color-mix(in_srgb,var(--md-sys-color-surface)_80%,transparent)] backdrop-blur-xl border-[color-mix(in_srgb,var(--md-sys-color-outline-variant)_35%,transparent)]">
    @error('composer.body')
