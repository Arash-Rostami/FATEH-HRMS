@php
    ...
    $scopeRows = [
        ...
        ['icon' => 'schedule', 'color' => 'secondary', 'label' => 'اسنپ‌شات ۵ دقیقه‌ای', 'text' => 'داده‌های نمودار با کشِ ۵ دقیقه‌ای ذخیره می‌شوند و میان درخواست‌ها باز استفاده می‌شوند؛ بنابراین ویرایش یک پروفایل بلافاصله در نمودارها ظاهر نمی‌شود و تا انقضای کش تأخیر دارد. برچسب «بروزرسانی» بالای هر نمودار قدمت همین اسنپ‌شات جاری را نشان می‌دهد.'],
