    ...
    <div>
        ...
        <div dir="rtl" class="flex flex-col gap-6 p-4 md:p-8">
            <div
                ...
                <div
                    class="absolute top-0 right-0 -mr-20 -mt-20 w-80 h-80 rounded-xl bg-[var(--md-sys-color-primary)]/10 blur-3xl pointer-events-none"></div>
                <div
                    class="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-xl bg-[var(--md-sys-color-tertiary)]/10 blur-3xl pointer-events-none"></div>
            ...
            <div class="flex gap-5 items-start">
                ...
                <aside class="flex-shrink-0 w-16 sm:w-52 flex flex-col gap-1 bg-[var(--md-sys-color-surface)] border border-[var(--md-sys-color-outline-variant)] rounded-xl p-2 shadow-sm sticky top-4">
