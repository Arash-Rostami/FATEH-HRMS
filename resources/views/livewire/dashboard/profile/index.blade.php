        ...
        <div class="w-full flex flex-col gap-5">
                ...
                <div
                    ...
                    <div class="flex items-center gap-6">
                        <div class="relative group">
                            ...
                            <x-dashboard.avatar
                                title="تصویر پروفایل"
                                :existingImage="$user->profile?->image ?? 'https://ui-avatars.com/api/?name='.urlencode($user->name).'&background=random'"
                                alt="{{ $user->name }}"
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-end mb-2">
                            ...
                            <span
                                class="text-lg font-bold text-[var(--md-sys-color-primary)]">{{ $completion }}%</span>
                        </div>
                        <div
                        ...
                        <p class="text-[11px] sm:text-xs text-[var(--md-sys-color-on-surface-variant)]
                      mt-2.5 opacity-80 leading-relaxed">
                            لطفاً برای دسترسی کامل به امکانات سیستم،
                            <a href="?activeTab=info"
                               class="inline-flex items-center gap-1 text-[var(--md-sys-color-primary)]
                          font-medium hover:underline focus:outline-none focus-visible:ring-2
            ...
            <div class="flex flex-col lg:flex-row gap-6 items-start">
                ...
                <aside
                    ...
                    @foreach([
                        'onboarding'  => ['label' => 'آنبوردینگ',  'icon' => 'apartment',     'sub' => 'آشنایی با شرکت'],
                    ...
                    <div
                        class="border-b border-[var(--md-sys-color-outline-variant)]/40 px-4 py-3 flex items-center gap-2 mb-2">
                         <span class="material-symbols-rounded text-[var(--md-sys-color-primary)]">
                             {{ ['onboarding' => 'apartment','info' => 'person', 'about' => 'psychology', 'documents' => 'folder_open', 'credentials' => 'verified_user'][$activeTab] }}                         </span>
                        <h2 class="text-sm font-bold text-[var(--md-sys-color-on-surface)]">
                            {{ ['onboarding' => ' آنبوردینگ (آشنایی با شرکت)','info' => 'ویرایش اطلاعات فردی',  'about' => 'درباره من', 'documents' => 'مدیریت مدارک و مستندات', 'credentials' => 'مشاهده دسترسی‌ها'][$activeTab] }}                            </h2>
                    </div>

                    <div class="p-2 sm:p-4">
                        @if($activeTab === 'onboarding')
                            <div class="animate-fade-in">
                                <livewire:dashboard.profile.onboarding
                                    wire:key="tab-onboarding"
                                    lazy="true"/>
                            </div>
