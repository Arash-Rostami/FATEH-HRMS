    ...
    <div class="max-w-[85rem] mx-auto">
        ...
        <div class="w-full flex flex-col gap-5">
                ...
                <div class="relative p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                    <div class="flex items-center gap-6">
                        <div class="relative group">
                            <div class="absolute inset-0 bg-gradient-to-tr from-[var(--md-sys-color-primary)] to-[var(--md-sys-color-tertiary)] rounded-full blur-md opacity-40 group-hover:opacity-60 transition-opacity duration-500"></div>
                            <img src="{{ $user->profile?->image ?? 'https://ui-avatars.com/api/?name='.urlencode($user->name).'&background=random' }}"
                                 alt="{{ $user->name }}"
                            ...
                            <div class="absolute bottom-0 right-0 w-6 h-6 bg-[var(--md-sys-color-primary)] border-2 border-[var(--md-sys-color-surface)] rounded-full flex items-center justify-center shadow-sm" title="وضعیت: فعال">
                                <span class="material-symbols-rounded text-[14px] text-[var(--md-sys-color-on-primary)]">check</span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-1">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="px-2 py-0.5 rounded-md bg-[var(--md-sys-color-primary-container)] text-[var(--md-sys-color-on-primary-container)] text-[10px] font-bold tracking-wide uppercase">
                            ...
                            <div class="flex flex-wrap items-center gap-3 mt-1">
                                ...
                                <span class="w-1 h-1 rounded-full bg-[var(--md-sys-color-outline-variant)]"></span>
                                <span class="inline-flex items-center gap-1.5 text-xs text-[var(--md-sys-color-on-surface-variant)]">
                    ...
                    <div class="w-full sm:w-64 bg-[var(--md-sys-color-surface-container-low)]/50 rounded-xl p-4 border border-[var(--md-sys-color-outline-variant)]/30 backdrop-blur-sm">
                        ...
                        <div class="h-2 w-full rounded-full bg-[var(--md-sys-color-surface-variant)] overflow-hidden">
                            <div class="h-full rounded-full bg-gradient-to-l from-[var(--md-sys-color-primary)] to-[var(--md-sys-color-tertiary)] transition-all duration-1000 ease-out"
            ...
            <div class="flex flex-col lg:flex-row gap-6 items-start">
                <!-- Sidebar Navigation -->
                <aside class="w-full lg:w-64 flex-shrink-0 flex flex-col gap-1 bg-[var(--md-sys-color-surface)] border border-[var(--md-sys-color-outline-variant)] rounded-2xl p-3 shadow-sm sticky top-4 z-10">
                    <div class="flex items-center gap-3 px-3 pt-2 pb-4 border-b border-[var(--md-sys-color-outline-variant)]/40 mb-2">
                        <div class="w-8 h-8 rounded-lg bg-[var(--md-sys-color-secondary-container)] flex items-center justify-center text-[var(--md-sys-color-on-secondary-container)]">
                            <span class="material-symbols-rounded text-lg">settings_account_box</span>
                        </div>
                        <span class="text-xs font-bold uppercase tracking-wider text-[var(--md-sys-color-on-surface-variant)]">مدیریت حساب</span>
                    </div>
                    ...
                    @foreach([
                        ...
                        >
                            <span class="material-symbols-rounded text-xl flex-shrink-0 {{ $activeTab === $key ? '' : 'opacity-70 group-hover:opacity-100' }}">
                                {{ $tab['icon'] }}
                            </span>
                            <div class="flex flex-col leading-none">
                                <span class="text-sm font-semibold">{{ $tab['label'] }}</span>
                                <span class="text-[10px] font-normal mt-1 {{ $activeTab === $key ? 'text-[var(--md-sys-color-on-primary)]/80' : 'opacity-60' }}">{{ $tab['sub'] }}</span>
                            </div>
                            @if($activeTab === $key)
                                <span class="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-rounded text-lg opacity-80">chevron_left</span>
                            @endif
                        </button>
                    @endforeach
                    ...
                    <div class="border-t border-[var(--md-sys-color-outline-variant)]/40 mt-2 pt-2 pb-1">
                        <a href="{{ route('dashboard') }}"
                           ...
                           class="flex items-center gap-3 rounded-xl px-3 py-2.5 bg-[var(--md-sys-color-primary-container)] text-[var(--md-sys-color-on-primary-container)] hover:brightness-95 active:scale-[0.98] transition-all duration-200">
                        ...
                        <div class="rounded-xl bg-[var(--md-sys-color-surface-variant)]/40 p-3 border border-[var(--md-sys-color-outline-variant)]/20">
                            <p class="text-[10px] font-bold text-[var(--md-sys-color-on-surface-variant)]/70 uppercase tracking-wider mb-1">آخرین فعالیت</p>
                            <p class="text-xs text-[var(--md-sys-color-on-surface)] font-medium dir-ltr text-right">
