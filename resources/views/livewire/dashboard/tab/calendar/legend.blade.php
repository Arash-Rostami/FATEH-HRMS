@php
    ...
    $ruleRows = [
        ...
        ['icon' => 'event_seat', 'color' => 'sage', 'label' => 'از طریق رزرو', 'text' => 'رزرو یک منبع جلسه خودکار این رویداد را می‌سازد و به اشتراک می‌گذارد؛ تغییر یا لغو فقط از تب «رزرو».'],
    ...
    $scheduleGroups = [
        ...
        'display' => [
            ['icon' => 'event_seat', 'color' => 'sage', 'label' => 'نوار رزرو', 'text' => 'رویدادهای رزرو به‌صورت نوار پیوسته فقط‌خواندنی در بالای ستون‌ها نمایش داده می‌شوند و قابل جابجایی نیستند.'],
