...
>
    <div class="modal-inner-card !w-full !max-w-none !p-5 md:!p-6" dir="rtl"
        ...
        @if(count($this->availableUsers) > 0)
            <div wire:key="calendar-share-users" class="max-h-64 overflow-y-auto custom-scrollbar rounded-2xl border border-[var(--md-sys-color-outline-variant)]/40 divide-y divide-[var(--md-sys-color-outline-variant)]/20">
        ...
        @else
            <div wire:key="calendar-share-users-empty" class="text-center py-10 text-[var(--md-sys-color-on-surface-variant)]">
