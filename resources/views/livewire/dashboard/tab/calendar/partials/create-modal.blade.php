    ...
    >
        ...
        <div class="p-6 pt-4 flex justify-end gap-3 bg-[var(--md-sys-color-surface)] border-t border-[var(--md-sys-color-outline-variant)]/50">
            ...
            <button
                ...
                class="px-8 py-3 rounded-xl bg-[var(--md-sys-color-primary)] text-[var(--md-sys-color-on-primary)] font-bold shadow-lg shadow-[var(--md-sys-color-primary)]/30 hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
            >
                @if($editingEventId)
