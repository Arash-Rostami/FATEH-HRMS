@php
    ...
    $timeline = [
        ['icon' => 'open_in_full', 'color' => 'primary', 'label' => 'کارت فعال بزرگ‌تر', 'text' => 'کارتِ فیدِ فعال در تایم‌لاین ۱.۱۵× بزرگ‌نمایی می‌شود و نقطهٔ آن روی خط زمان پررنگ می‌شود. با دکمه‌های چپ/راست بین فیدها جابه‌جا شوید؛ Esc کارتِ بازشده را کوچک می‌کند. در موبایل همهٔ کارت‌ها هم‌اندازه‌اند و ارتفاع هر کارت با محتوایش تنظیم می‌شود.'],
        ...
        ['icon' => 'expand_more', 'color' => 'tertiary', 'label' => 'گسترش متن', 'text' => 'متن طولانی‌تر از ۱۶۰ کاراکتر با گرادیان جمع می‌شود؛ «مشاهده بیشتر» متن کامل را باز می‌کند. دکمهٔ گوشه کارت (فقط دسکتاپ)، فید را تمام‌صفحه می‌کند.'],
