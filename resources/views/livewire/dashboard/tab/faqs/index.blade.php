    ...
    <div
        ...
        @forelse($this->faqs as $faq)
            <div
                ...
                class="group flex flex-col rounded-xl overflow-hidden transition-all duration-300 border border-[var(--md-sys-color-outline-variant)] hover:border-[var(--md-sys-color-primary)]/50 hover:shadow-md bg-[var(--md-sys-color-surface)] max-w-7xl mx-auto w-full"
