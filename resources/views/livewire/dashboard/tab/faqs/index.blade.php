<div
    ...
    class="relative w-full h-full flex flex-col bg-[var(--md-sys-color-background)] overflow-hidden p-4 md:p-8"
    dir="rtl"
>
    {{-- Header Section (Fixed) --}}
    <div class="shrink-0 z-10 bg-[var(--md-sys-color-surface)]/90 transition-all duration-300 rounded-xl">
        <div class="p-4 space-y-3 max-w-7xl mx-auto w-full">
            ...
            >
                <div class="pt-2 pb-1 space-y-2">
                    ...
                    <div class="flex flex-wrap gap-2 overflow-x-auto no-scrollbar pb-2 mask-linear-fade">
                        @foreach($this->departments as $dept)
                            <div class="group/dept relative shrink-0">
                                ...
                                >
                                    <span class="truncate max-w-[140px]" title="  {{ $dept->description }}">{{ $dept->name }}</span>
                                </button>
                            </div>
                        @endforeach
                    </div>
