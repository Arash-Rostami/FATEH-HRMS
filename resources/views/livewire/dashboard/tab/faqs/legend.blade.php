@php
    ...
    $viewRows = [
        ['icon' => 'expand_more', 'color' => 'primary', 'label' => 'باز و بسته شدن', 'text' => 'کلیک روی هر پرسش — چه در نمای کارت و چه در نمای فهرست — پاسخ را با انیمیشن باز می‌کند؛ کلیک دوباره آن را می‌بندد. لینک‌های داخل پاسخ خودکار در زبانهٔ جدید مرورگر باز می‌شوند.'],
