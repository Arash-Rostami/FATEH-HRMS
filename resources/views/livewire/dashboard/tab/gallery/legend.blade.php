@php
    ...
    $timelineRows = [
        ['icon' => 'view_carousel', 'color' => 'primary', 'label' => 'تایم‌لاین و ریل', 'text' => 'گالری‌ها به‌صورت کارت‌های اسکرولِ افقی نمایش داده می‌شوند؛ ریل و نقطهٔ کناری صرفاً تزئینی‌اند و با دکمهٔ «مخفی/نمایش تایم‌لاین» پنهان یا ظاهر می‌شوند. کارتِ فعال بزرگ‌تر می‌شود (در دسکتاپ؛ در موبایل همهٔ کارت‌ها هم‌اندازه‌اند).'],
