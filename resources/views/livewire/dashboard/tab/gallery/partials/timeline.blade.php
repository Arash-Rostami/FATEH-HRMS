    ...
    >
        @foreach($this->photos as $photo)
            <div
                ...
                class="shrink-0 w-full max-w-md h-[70vh] md:h-[80vh] md:w-[400px] snap-center transition-all duration-500 ease-out relative bg-[var(--md-sys-color-surface)] rounded-xl"
                :class="{
                        'z-30 scale-105 !bg-[var(--md-sys-color-primary-container)]': activeId == {{ $photo->id }},
