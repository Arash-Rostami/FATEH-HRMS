<style>
    ...
    .glass-panel {
        background: rgba(var(--md-sys-color-surface-rgb), 0.95); /* More opaque */
    ...
    .glass-header {
        ...
        border-bottom: 1px solid rgba(var(--md-sys-color-outline-variant-rgb), 0.1);
    }

    .glass-footer {
        background: var(--md-sys-color-surface-container-low);
        border-top: 1px solid rgba(var(--md-sys-color-outline-variant-rgb), 0.1);
    }

    /* Custom Scrollbar */
    .feed-scrollbar {
        scrollbar-width: thin;
        scrollbar-color: rgba(var(--md-sys-color-outline-variant-rgb), 0.3) transparent;
    }
