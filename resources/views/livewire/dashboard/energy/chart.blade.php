        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-6 items-start flex-1 min-h-[300px] w-full">
            <div x-data="{
                    ...
                    sync() {
                        ...
                        const host = this.max ? this.$refs.historyModalHost : this.$refs.historyInlineHost;
                 ...
                 x-init="$nextTick(() => sync()); $watch('max', () => $nextTick(() => sync()))"
                 @keydown.escape.window="max = false"
                 class="order-2 lg:order-1 h-full w-full">

                <div x-show="!max"
                     class="w-full h-full rounded-3xl border border-[var(--md-sys-color-outline-variant)]/40 bg-[var(--md-sys-color-surface)] shadow-sm flex flex-col">
                    <header
                        ...
                        <button @click="max = true"
                                :title="'بزرگ کردن'"
                                class="ml-auto flex size-7 items-center justify-center rounded-lg hover:bg-[var(--md-sys-color-surface-variant)] transition-colors text-[var(--md-sys-color-on-surface-variant)]">
                ...
                <template x-teleport="body">
                    <div x-cloak x-show="max" @click.self="max = false"
                         class="fixed inset-0 z-[999999] p-4 md:p-10 flex items-center justify-center bg-[var(--md-sys-color-primary)]/60 animate-slide-down">
                        <div
                            class="w-full max-w-5xl h-full max-h-[85vh] rounded-3xl shadow-2xl overflow-y-auto bg-[var(--md-sys-color-surface)] border border-[var(--md-sys-color-outline-variant)]/40 flex flex-col">
                            <header
                                class="px-5 py-4 border-b border-[var(--md-sys-color-outline-variant)]/30 flex items-center gap-3 bg-[var(--md-sys-color-surface)] rounded-t-3xl">
                                <div
                                    class="flex size-8 items-center justify-center rounded-xl bg-[var(--md-sys-color-secondary-container)]/60 text-[var(--md-sys-color-on-secondary-container)]">
                                ...
                                <h2 class="text-sm font-semibold text-[var(--md-sys-color-on-surface)]">روند ۱۸ ماه
                                    اخیر</h2>
                                <button @click="max = false"
                                        :title="'کوچک کردن'"
                                        class="ml-auto flex size-7 items-center justify-center rounded-lg hover:bg-[var(--md-sys-color-surface-variant)] transition-colors text-[var(--md-sys-color-on-surface-variant)]">
                                    <span class="material-symbols-rounded text-[18px]">close_fullscreen</span>
                                </button>
                            </header>

                            <div class="relative w-full flex-1 p-4 lg:p-5 min-h-[280px] h-[60vh]">
                                <div x-ref="historyModalHost" class="w-full h-full"></div>
                            </div>
                        </div>
                    </div>
                </template>
            ...
            <div x-data="{ max: false }"
                ...
                <div x-show="!max"
                     class="w-full h-full rounded-3xl border border-[var(--md-sys-color-outline-variant)]/40 p-5 lg:p-8 overflow-hidden shadow-sm flex flex-col items-center text-center relative justify-center bg-[var(--md-sys-color-surface)]">
                    <button @click="max = true"
                            :title="'بزرگ کردن'"
                            class="absolute top-4 left-4 z-20 flex size-8 items-center justify-center rounded-lg hover:bg-[var(--md-sys-color-surface-variant)] transition-colors text-[var(--md-sys-color-on-surface-variant)] bg-[var(--md-sys-color-surface)]/50 backdrop-blur-md">
                ...
                <template x-teleport="body">
                    <div x-cloak x-show="max" @click.self="max = false"
                         class="fixed inset-0 z-[999999] p-4 md:p-10 flex items-center justify-center bg-[var(--md-sys-color-primary)]/60 animate-slide-down">
                        <div
                            class="w-full max-w-3xl h-full max-h-[85vh] rounded-3xl shadow-2xl overflow-y-auto p-8 bg-[var(--md-sys-color-surface)] border border-[var(--md-sys-color-outline-variant)]/40 flex flex-col items-center text-center relative justify-center">
                            <button @click="max = false"
                                    :title="'کوچک کردن'"
                                    class="absolute top-4 left-4 z-20 flex size-8 items-center justify-center rounded-lg hover:bg-[var(--md-sys-color-surface-variant)] transition-colors text-[var(--md-sys-color-on-surface-variant)] bg-[var(--md-sys-color-surface)]/50 backdrop-blur-md">
                            ...
                            <div
                                class="z-10 flex flex-col items-center justify-center space-y-4 flex-1 w-full max-w-xl mt-4 lg:mt-0">
                                <div class="flex flex-col items-center">
                                    <h2 class="text-base font-semibold text-[var(--md-sys-color-on-surface)]">آخرین
                                        نتیجه ارزیابی</h2>
                                    <time class="text-sm font-medium text-[var(--md-sys-color-on-surface-variant)] mt-1"
                                          datetime="{{ $latestTest['completed_at'] ?? '' }}" dir="ltr">
                                        {{ \Morilog\Jalali\Jalalian::forge($latestTest['completed_at'] ?? now())->format('Y-m-d H:i:s') }}
                                ...
                                <div class="flex flex-col items-center justify-center mt-2">
                                    <div
                                        class="flex size-24 lg:size-28 items-center justify-center rounded-full bg-gradient-to-br from-[var(--md-sys-color-primary)] to-[var(--md-sys-color-primary)]/80 text-[var(--md-sys-color-on-primary)] shadow-lg shadow-[var(--md-sys-color-primary)]/20 ring-4 ring-[var(--md-sys-color-primary)]/10 mb-4 relative">
                                        <span
                                            class="text-5xl lg:text-6xl font-black tracking-tighter">{{ $overall }}</span>
                                        <div class="absolute inset-0 rounded-full border-2 border-white/20"></div>
                                    </div>
                                    <h3 class="text-lg font-bold text-[var(--md-sys-color-on-surface)]">شاخص کل
                                        عملکرد</h3>
                                    <p class="text-sm font-medium mt-2 px-4 py-1.5 rounded-full bg-[var(--md-sys-color-surface-variant)] text-[var(--md-sys-color-on-surface-variant)] inline-flex items-center gap-2">
                                        <span
                                            class="size-2 rounded-full bg-[var(--md-sys-color-primary)] animate-pulse"></span>
                                        {{ $presenter->getOverallMessage($overall) }}
                                    </p>
                                </div>
                            </div>
            ...
            <div x-data="{
                    ...
                    sync() {
                        ...
                        const host = this.max ? this.$refs.radarModalHost : this.$refs.radarInlineHost;
                        if (canvas && host && canvas.parentElement !== host) {
                            host.appendChild(canvas);
                        }
                        $nextTick(() => window.dispatchEvent(new Event('resize')));
                 ...
                 x-init="$nextTick(() => sync()); $watch('max', () => $nextTick(() => sync()))"
                 @keydown.escape.window="max = false"
                 class="order-3 flex flex-col gap-5 lg:gap-6 h-full w-full">

                <div x-show="!max" class="w-full flex flex-col flex-1">
                    <div class="relative flex-1 min-h-[250px] w-full h-full">
                        <div
                            class="w-full h-full rounded-3xl border border-[var(--md-sys-color-outline-variant)]/40 bg-[var(--md-sys-color-surface)] shadow-sm flex flex-col">
                            <header
                                class="px-5 py-4 border-b border-[var(--md-sys-color-outline-variant)]/30 flex items-center gap-3 bg-[var(--md-sys-color-surface)] rounded-t-3xl">
                                <div
                                    class="flex size-8 items-center justify-center rounded-xl bg-[var(--md-sys-color-tertiary-container)]/60 text-[var(--md-sys-color-on-tertiary-container)]">
                                    <span class="material-symbols-rounded text-base" aria-hidden="true">radar</span>
                                </div>
                                <h2 class="text-sm font-semibold text-[var(--md-sys-color-on-surface)]">مقایسه
                                    سازمانی</h2>
                                <button @click="max = true"
                                        :title="'بزرگ کردن'"
                                        class="ml-auto flex size-7 items-center justify-center rounded-lg hover:bg-[var(--md-sys-color-surface-variant)] transition-colors text-[var(--md-sys-color-on-surface-variant)]">
                            ...
                            <div class="relative w-full flex-1 flex items-center justify-center p-4">
                                <div x-ref="radarInlineHost"
                                     class="w-full h-full relative flex items-center justify-center max-w-[250px]">
                                    <canvas id="radarChart" role="img"
                                            aria-label="نمودار راداری مقایسه عملکرد"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <template x-teleport="body">
                    <div x-cloak x-show="max" @click.self="max = false"
                         class="fixed inset-0 z-[999999] p-4 md:p-10 flex items-center justify-center !bg-[var(--md-sys-color-primary)]/60 animate-slide-down">
                        <div
                            class="w-full max-w-4xl h-full max-h-[85vh] rounded-3xl shadow-2xl overflow-y-auto border border-[var(--md-sys-color-outline-variant)]/40 bg-[var(--md-sys-color-surface)] flex flex-col">
                            <header
                                class="px-5 py-4 border-b border-[var(--md-sys-color-outline-variant)]/30 flex items-center gap-3 bg-[var(--md-sys-color-surface)] rounded-t-3xl">
                                <div
                                    class="flex size-8 items-center justify-center rounded-xl bg-[var(--md-sys-color-tertiary-container)]/60 text-[var(--md-sys-color-on-tertiary-container)]">
                            ...
                            <div class="relative w-full flex-1 flex items-center justify-center p-4 h-[60vh]">
                                <div x-ref="radarModalHost"
                                     class="w-full h-full relative flex items-center justify-center max-w-[450px]"></div>
                            </div>
                        </div>
                    </div>
                </template>
                ...
                @if($isManager && count($teamMembersData))
                    <div x-data="{ max: false }" @keydown.escape.window="max = false"
                         class="w-full flex flex-col flex-1">
                        <div x-show="!max" class="relative max-h-[250px] flex-1 w-full h-full">
                            <div
                                class="w-full h-full rounded-3xl border border-[var(--md-sys-color-outline-variant)]/40 bg-[var(--md-sys-color-surface)] shadow-sm overflow-hidden flex flex-col">
                                <header
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button @click="max = true"
                                                :title="'بزرگ کردن'"
                                                class="flex size-7 items-center justify-center rounded-lg hover:bg-[var(--md-sys-color-surface-variant)] transition-colors text-[var(--md-sys-color-on-surface-variant)]">
                                            <span class="material-symbols-rounded text-[18px]">open_in_full</span>
                                        </button>
                                    </div>
                                </header>
                        ...
                        <template x-teleport="body">
                            <div x-cloak x-show="max" @click.self="max = false"
                                 class="fixed inset-0 z-[999999] p-4 md:p-10 flex items-center justify-center bg-[var(--md-sys-color-primary)]/60 animate-slide-down">
                                <div
                                    class="w-full max-w-3xl h-full max-h-[85vh] rounded-3xl shadow-2xl bg-[var(--md-sys-color-surface)] border border-[var(--md-sys-color-outline-variant)]/40 overflow-hidden flex flex-col">
                                    <header
                                        class="px-5 py-3 border-b border-[var(--md-sys-color-outline-variant)]/30 flex items-center justify-between  bg-[var(--md-sys-color-primary)]/60  top-0 z-10 rounded-t-3xl">
                                        <div class="flex items-center gap-2">
                                            <div
                                            ...
                                            <h2 class="text-sm font-semibold text-[var(--md-sys-color-on-surface)]">
                                                اعضای تیم</h2>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            <span
                                            ...
                                            <button @click="max = false"
                                                    ...
                                                    class="flex size-7 items-center justify-center rounded-lg hover:bg-[var(--md-sys-color-surface-variant)] transition-colors text-[var(--md-sys-color-on-surface-variant)]">
                                                <span
                                                    class="material-symbols-rounded text-[18px]">close_fullscreen</span>
                                            </button>
                                        </div>
                                    </header>
                                    <div class="overflow-x-auto overflow-y-auto flex-1 custom-scrollbar">
