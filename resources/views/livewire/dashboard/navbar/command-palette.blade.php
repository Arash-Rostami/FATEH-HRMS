<div x-data="{
    ...
    <button @click="toggle()"
            class="hidden md:flex items-center gap-3 px-3 py-1.5 rounded-xl bg-[var(--md-sys-color-surface-container-high)]/50 border border-[var(--md-sys-color-outline-variant)]/20 hover:bg-[var(--md-sys-color-surface-container-high)] transition-colors group">
