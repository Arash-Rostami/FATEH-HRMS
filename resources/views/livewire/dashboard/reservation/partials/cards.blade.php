    ...
    @if($this->totalResources > count($this->resources))
        <div class="mt-8 flex justify-center w-full">
            <x-dashboard.button.load-more
                ...
                icon="expand_more"
                class="px-6 py-2.5 rounded-xl bg-[var(--md-sys-color-surface-container-high)] text-[var(--md-sys-color-on-surface-variant)] hover:bg-[var(--md-sys-color-surface-variant)] hover:text-[var(--md-sys-color-on-surface)] text-sm font-semibold shadow-sm"
            />
        </div>
    @endif
@endif
