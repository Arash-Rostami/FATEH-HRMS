...
>
    <div class="transition-all duration-300 max-w-[88rem] mx-auto page-wrapper">
        ...
        <div class="mb-8 animate-slide-up-fade flex flex-col gap-6">
            ...
            @includeWhen($activeTab == 'meeting',
                                  'livewire.dashboard.reservation.partials.time')

            @includeWhen($activeTab === 'seat' || $activeTab === 'spot',
                                 'livewire.dashboard.reservation.partials.filter')
