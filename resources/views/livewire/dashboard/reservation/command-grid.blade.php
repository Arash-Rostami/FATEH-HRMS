<div>
    ...
    <div :class="{ 'max-widget': max }">
        ...
        <div class="relative min-h-[300px] rounded-2xl border border-[var(--md-sys-color-outline-variant)] bg-[var(--md-sys-color-surface)] shadow-sm">
            <div class="w-full overflow-x-auto">
                <table class="reservation-command-table min-w-full w-full border-separate border-spacing-0 text-sm">
                                ...
                                <div class="flex items-center justify-end w-full gap-1">
                                    ...
                                    <div x-data="{ open: false }" @click.away="open = false" class="relative">
                                        <button type="button"
                                            ...
                                            <span x-show="$store.colVisibility.reservationHidden.length > 0" class="absolute -left-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-[var(--md-sys-color-error)] px-1 text-[9px] font-bold text-white" x-text="$store.colVisibility.reservationHidden.length" style="display: none;"></span>
                                        </button>
                                        ...
                                        <div x-show="open"
                                            ...
                                            <div class="mb-1.5 flex items-center justify-between px-1.5">
                                                ...
                                                <button type="button"
                                                        @click="$store.colVisibility.reset('reservation')"
                                                        :disabled="$store.colVisibility.reservationHidden.length === 0"
                                            ...
                                            <div class="flex flex-col gap-0.5">
                                                @foreach($gridColumns as $colKey => $colLabel)
                                                    <button type="button" @click="$store.colVisibility.toggle('{{ $colKey }}', 'reservation')" class="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-right transition-colors hover:bg-[var(--md-sys-color-surface-container-highest)]">
                                                        <span class="material-symbols-rounded text-[18px]" :class="$store.colVisibility.isHidden('{{ $colKey }}', 'reservation') ? 'text-[var(--md-sys-color-outline)]' : 'text-[var(--md-sys-color-primary)]'" x-text="$store.colVisibility.isHidden('{{ $colKey }}', 'reservation') ? 'check_box_outline_blank' : 'check_box'"></span>
