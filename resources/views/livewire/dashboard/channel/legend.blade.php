@php
    ...
    $rows = [
        'owner' => [
            ...
            ['icon' => 'hourglass_top', 'color' => 'secondary', 'label' => 'در انتظار ورود', 'text' => 'در «اطلاعات کانال»، فهرست «در انتظار ورود» کسانی را نشان می‌دهد که دعوت کرده‌اید اما هنوز یک‌بار وارد کانال نشده‌اند؛ تا وقتی دعوت را دریافت نکرده باشند می‌توانید با دکمهٔ ضربدر آن را لغو کنید، اما پس از دیدن دعوت، لغو ممکن نیست. با نخستین ورودشان خودبه‌خود از فهرست حذف می‌شوند.'],
