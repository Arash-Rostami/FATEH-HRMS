<footer x-show="!isEditing" class="flex-shrink-0 border-t backdrop-blur-sm bg-[color-mix(in_srgb,var(--md-sys-color-surface)_90%,transparent)] border-[color-mix(in_srgb,var(--md-sys-color-outline-variant)_30%,transparent)]">
    @error('composer.body')
        ...
        <div class="flex flex-wrap items-center gap-1.5 px-4 py-2.5">
            <div x-data="{ len: 0 }"
                ...
                <span x-show="len > 3600"
                      ...
                      :class="len > 3900 ? 'text-[var(--md-sys-color-error)]' : 'text-[color-mix(in_srgb,var(--md-sys-color-on-surface-variant)_60%,transparent)]'"
