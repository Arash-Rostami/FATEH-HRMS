...
<x-ui.modals.action
    ...
    title="{{ $isEditMode ? 'ویرایش وظیفه' : 'ایجاد وظیفه جدید' }}"
...
>
    <div class="modal-inner-card" dir="rtl" x-data="{ tab: '{{ $defaultTab }}' }">
        ...
        <div x-show="tab === 'content'" class="space-y-5 md:space-y-6">
            ...
            <x-ui.forms.textarea label="توضیحات" name="form.newDescription" wire:model="form.newDescription" icon="notes" rows="3"/>
