...
>
    ...
    <div class="flex items-center justify-between px-2 mb-2">
        <div class="flex items-center gap-3">
            <div
                class="w-10 h-10 rounded-xl bg-gradient-to-br {{ $config['lightGradient'] }} text-white flex items-center justify-center shadow-md shadow-{{ $config['color'] }}-500/30">
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden space-y-3 px-1 custom-scrollbar scroll-smooth">
        ...
        @empty
            <div
                class="flex flex-col items-center justify-center h-48 text-[var(--md-sys-color-on-surface-variant)]/40 border-2 border-dashed border-[var(--md-sys-color-outline-variant)]/30 rounded-2xl bg-[var(--md-sys-color-surface)]/30">
        ...
        <div x-show="dragTask && $el.closest('[data-column=\" {{ $column }}\
        "]')" class="h-24 rounded-2xl border-2 border-dashed border-[var(--md-sys-color-primary)]
        bg-[var(--md-sys-color-primary)]/5 flex items-center justify-center text-[var(--md-sys-color-primary)] font-bold
        animate-pulse">
        رها کنید
    </div>
</div>
