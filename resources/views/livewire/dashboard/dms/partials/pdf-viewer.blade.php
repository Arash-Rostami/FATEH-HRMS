<template x-teleport="body">
    ...
    >
        <!-- Content -->
        <div class="bg-[var(--md-sys-color-surface-container-high)] w-full max-w-6xl h-[90vh] md:h-[95vh] rounded-lg shadow-[0_8px_32px_rgba(0,0,0,0.12)] border border-[var(--md-sys-color-outline-variant)]/30 flex flex-col overflow-hidden transition-all duration-300 transform"
            ...
            <div class="shrink-0 p-5 bg-[var(--md-sys-color-surface)] border-t border-[var(--md-sys-color-outline-variant)]/50 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto justify-end shrink-0">
                    <button type="button" @click="show = false" class="h-11 px-6 rounded-lg text-sm font-bold text-[var(--md-sys-color-primary)] hover:bg-[var(--md-sys-color-primary)]/10 transition-colors">
                        انصراف
                    </button>
                    <button type="button"
                            @click="
