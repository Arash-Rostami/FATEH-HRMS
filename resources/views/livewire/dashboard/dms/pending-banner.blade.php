...
@if($this->receivePendingCount > 0 || $this->readPendingCount > 0)
    <div wire:key="dms-pending-banner" class="relative z-20 flex gap-3 rounded-2xl border border-[var(--md-sys-color-error)]/20 bg-[var(--md-sys-color-error)]/10 p-4 shadow-sm animate-fade-in-up">
