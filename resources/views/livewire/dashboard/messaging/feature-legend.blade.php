@php
    ...
    $sections = [
        ...
        'write' => [
            ...
            ['icon' => 'alternate_email', 'tone' => 'tertiary', 'scope' => 'channels', 'label' => 'اشاره به عضو با @', 'text' => 'در کانال، بعد از تایپ @ فهرست اعضا باز می‌شود؛ با کلیک یا Enter انتخاب کنید. نام در پیام هایلایت می‌شود و اگر به شما اشاره شده باشد، نشان «اشاره به شما» روی حباب می‌افتد.'],
        ],
        'search' => [
