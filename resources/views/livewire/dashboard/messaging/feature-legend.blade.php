@php
    ...
    $tabs = [
        ...
        ['id' => 'pin',      'icon' => 'push_pin',   'label' => 'سنجاق'],
    ...
    $sections = [
        'pin' => [
            ['icon' => 'push_pin', 'tone' => 'primary', 'scope' => 'shared', 'label' => 'سنجاق گفتگو/کانال', 'text' => 'در نوار کناریِ پیام‌رسان و کانال، نشانهٔ سنجاق کنار دکمهٔ بی‌صدا قرار دارد؛ روی هاور نمایان می‌شود. با سنجاق کردن، گفتگو/کانال بالای فهرست می‌آید و نشانه پر، کج و روی یک پس‌زمینهٔ رنگی ثابت می‌ماند (نه فقط هاور). دوباره بزنید تا سنجاق برداشته شود. تنظهمان فقط روی همین مرورگر ذخیره می‌شود و روی ترتیب پیام‌ها اثری ندارد.'],
            ['icon' => 'palette', 'tone' => 'tertiary', 'scope' => 'shared', 'label' => 'رنگ‌آمیزی ردیف', 'text' => 'کنار سنجاق و بی‌صدا، نشانهٔ پالت رنگ را بزنید تا ۵ رنگ باز شود؛ رنگی را برگزینید تا پس‌زمینهٔ همان گفتگو/کانال در نوار کناری به آن رنگ درآید و پیدا کردنش آسان شود. دکمهٔ ✕ رنگ را برمی‌دارد. رنگ فقط روی همین مرورگر ذخیره می‌شود و روی خود گفتگو/کانال اثری ندارد.'],
        ...
        'write' => [
            ...
            ['icon' => 'counter_1', 'tone' => 'secondary', 'scope' => 'shared', 'label' => 'شمارنده و سقف کاراکتر', 'text' => 'شمارنده از ۱۸۰۰ (پیام‌رسان) و ۳۶۰۰ (کانال) به بالا نمایش داده می‌شود؛ سقف پیام‌رسان ۲۰۰۰ و کانال ۴۰۰۰ کاراکتر است.'],
            ...
            ['icon' => 'alternate_email', 'tone' => 'tertiary', 'scope' => 'channels', 'label' => 'اشاره به عضو با @', 'text' => 'در کانال، بعد از تایپ @ فهرست اعضا با نقطهٔ رنگی وضعیت حضور هرکدام باز می‌شود؛ با کلیک یا Enter انتخاب کنید. نام در پیام هایلایت می‌شود و اگر به شما اشاره شده باشد، نشان «اشاره به شما» روی حباب می‌افتد.'],
        ],
        'search' => [
        ...
        'notify' => [
            ...
            ['icon' => 'alternate_email', 'tone' => 'secondary', 'scope' => 'channels', 'label' => 'اعلان اشاره به شما', 'text' => 'وقتی در کانالی که باز نیست با @ به شما اشاره شود، یک اعلان پایین صفحه ظاهر می‌شود؛ با «رفتن به پیام» به همان پیام می‌روید. باز کردن کانال، اعلان را خودکار پاک می‌کند.'],
