        ...
        <div x-data="{ uploading: false, uploadProgress: 0, uploaded: false }"
            ...
            <div class="flex flex-col md:flex-row gap-4">
                <aside class="w-full md:w-80 shrink-0">
                    ...
                    @include('livewire.dashboard.suggestion.partials.list')

                </aside>

                <main class="flex-1 min-w-0">

                    @includeWhen($panel === 'empty', 'livewire.dashboard.suggestion.partials.placeholder')

                    @includeWhen($panel === 'create', 'livewire.dashboard.suggestion.partials.create')
