@php
    $pills = [
        ['id' => 'stages', 'icon' => 'route', 'label' => 'مراحل و خودکارسازی'],
        ['id' => 'roles', 'icon' => 'group', 'label' => 'نقش‌ها و اقدام‌ها'],
...
<div x-data="{ tab: 'stages', role: 'submitter' }">
    ...
    <div x-show="tab === 'stages'" x-cloak class="space-y-3">
        @foreach($stages as $s)
