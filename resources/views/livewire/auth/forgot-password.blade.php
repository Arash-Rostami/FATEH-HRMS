            ...
            <div class="md3-input-group group relative">
                <div class="relative transition-transform duration-300 focus-within:scale-[1.02]">
                    <input wire:model.lazy="email" type="email" id="email" required autocomplete="email"
                           class="md3-input peer ps-14 pe-4 py-4 text-lg bg-[var(--md-sys-color-surface-variant)]/30 focus:bg-[var(--md-sys-color-surface-variant)]/50" placeholder=" " />
                    ...
                    <span class="material-symbols-rounded absolute top-[22px] rtl:right-4 ltr:left-4 text-[24px] text-[var(--md-sys-color-on-surface-variant)] transition-colors duration-300 peer-focus:text-[var(--md-sys-color-secondary)] pointer-events-none">alternate_email</span>
                </div>
                @error('email')
