<x-auth-card title="ورود به سیستم" description="جهت دسترسی به پنل کاربری، اطلاعات ورود خود را وارد نمایید.">
    <x-slot:imageContent>
        {{-- Custom Login Branding for Left Panel --}}
        ...
        <div class="space-y-4 text-center relative z-10">
            <h2 class="text-3xl font-bold text-[var(--md-sys-color-on-surface)] tracking-tight drop-shadow-sm">ERP Secure Gate</h2>
            <p class="text-[var(--md-sys-color-on-surface-variant)] text-lg max-w-[250px] mx-auto leading-relaxed font-medium">
                سامانه جامع مدیریت منابع سازمانی<br>احراز هویت امن
            </p>
        </div>
    </x-slot:imageContent>
        ...
        <form wire:submit.prevent="login" class="space-y-6">
            <div class="space-y-5">
                ...
                <div class="md3-input-group group relative">
                    ...
                    @error('email')
                    <div class="mt-1 flex items-center gap-2 text-xs font-medium text-[var(--md-sys-color-error)] animate-slide-up" role="alert">
            ...
            <div class="flex items-center justify-between px-1">
                <label class="flex items-center gap-2.5 cursor-pointer group select-none py-1">
                    ...
                    <div class="relative w-[44px] h-[26px] rounded-full transition-colors duration-200 ease-in-out shadow-inner"
                         :class="remember ? 'bg-[var(--md-sys-color-primary)]' : 'bg-[var(--md-sys-color-surface-container-highest)]'">
                        <div class="absolute top-1/2 -translate-y-1/2 ltr:left-1 rtl:right-1 w-[18px] h-[18px] rounded-full bg-white shadow-md transform transition-all duration-200 ease-in-out flex items-center justify-center"
                    ...
                    <span class="text-xs font-bold text-[var(--md-sys-color-on-surface-variant)] group-hover:text-[var(--md-sys-color-on-surface)] transition-colors">
                        شناسایی دستگاه
                    </span>
                </label>
            ...
            <div class="space-y-4 pt-2">
                <button type="submit"
                    ...
                    <div class="relative flex items-center justify-center gap-2 w-full">
                        <span class="material-symbols-rounded text-[22px]" wire:loading.remove wire:target="login">login</span>

                        <svg class="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" wire:loading wire:target="login">
