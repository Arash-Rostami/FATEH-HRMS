<button
    wire:click="logout"
    type="button"
    class="{{ $iconOnly ? 'w-10 h-10 p-0 rounded-full flex items-center justify-center transition-colors' : 'md3-btn-text' }} group !text-[var(--md-sys-color-error)] hover:!bg-[var(--md-sys-color-error-container)]/20 relative overflow-hidden"
    x-data="{ hover: false }"
