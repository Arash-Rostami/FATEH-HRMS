<button
    ...
    class="{{ $iconOnly
        ...
        : 'md3-btn-text flex items-center gap-2'
    }} group !text-[var(--md-sys-color-error)] hover:!bg-[var(--md-sys-color-error-container)]/20 relative overflow-hidden cursor-pointer"
    x-data="{ hover: false }"
