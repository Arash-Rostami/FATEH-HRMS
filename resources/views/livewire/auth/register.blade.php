<div class="flex items-center justify-center min-h-[calc(100vh-6rem)] w-full px-4 py-8">
    ...
    <div x-data="{ showPassword: false, showConfirm: false, strength: 0 }"
         class="glass-panel w-full max-w-[600px] p-10 md:p-12 rounded-[2.5rem] relative overflow-hidden isolate shadow-2xl ring-1 ring-white/10">
        <!-- Stylistic Shapes -->
        <x-dashboard.floating-shapes/>

        <!-- Ambient Background Glows -->
        <div class="absolute -top-48 -right-48 w-96 h-96 bg-[var(--md-sys-color-primary)]/20 rounded-full blur-[100px] pointer-events-none mix-blend-screen opacity-50"></div>
        <div class="absolute -bottom-48 -left-48 w-96 h-96 bg-[var(--md-sys-color-tertiary)]/20 rounded-full blur-[100px] pointer-events-none mix-blend-screen opacity-50"></div>
        ...
        <form wire:submit.prevent="register" class="space-y-6 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Full Name -->
                <div class="md3-input-group group relative col-span-1 md:col-span-2">
                    <div class="relative transition-transform duration-300 focus-within:scale-[1.01]">
                        <input wire:model.lazy="name" type="text" id="name" required autocomplete="name"
                               class="md3-input peer ps-14 pe-4 py-3.5 text-lg bg-[var(--md-sys-color-surface-variant)]/30 focus:bg-[var(--md-sys-color-surface-variant)]/50" placeholder=" " />
                        ...
                        <span class="material-symbols-rounded absolute top-[20px] rtl:right-4 ltr:left-4 text-[24px] text-[var(--md-sys-color-on-surface-variant)] transition-colors duration-300 peer-focus:text-[var(--md-sys-color-primary)] pointer-events-none">badge</span>
                    </div>
                    @error('name')
                ...
                <div class="md3-input-group group relative col-span-1 md:col-span-2">
                    <div class="relative transition-transform duration-300 focus-within:scale-[1.01]">
                        <input wire:model.lazy="email" type="email" id="email" required autocomplete="email"
                               class="md3-input peer ps-14 pe-4 py-3.5 text-lg bg-[var(--md-sys-color-surface-variant)]/30 focus:bg-[var(--md-sys-color-surface-variant)]/50" placeholder=" " />
                        ...
                        <span class="material-symbols-rounded absolute top-[20px] rtl:right-4 ltr:left-4 text-[24px] text-[var(--md-sys-color-on-surface-variant)] transition-colors duration-300 peer-focus:text-[var(--md-sys-color-primary)] pointer-events-none">alternate_email</span>
                    </div>
                    @error('email')
                    <div class="mt-2 flex items-center gap-2 text-sm font-medium text-[var(--md-sys-color-error)] animate-slide-up">
                        <span class="material-symbols-rounded text-[18px]">error</span>
                ...
                <div class="md3-input-group group relative" x-data="password">
                    ...
                    <!-- Strength Bars -->
                    <div class="flex gap-1 mt-2 h-1 px-1 opacity-0 transition-opacity duration-300" :class="{ 'opacity-100': showIndicator }">
                        <div class="flex-1 rounded-full bg-[var(--md-sys-color-surface-variant)] overflow-hidden">
                            <div class="h-full w-full transition-all duration-500 origin-left"
                                 :class="[bar1Color, { 'translate-x-full rtl:-translate-x-full': strength < 1 }]"></div>
                        </div>
                        <div class="flex-1 rounded-full bg-[var(--md-sys-color-surface-variant)] overflow-hidden">
                            <div class="h-full w-full transition-all duration-500 origin-left"
                                 :class="[bar2Color, { 'translate-x-full rtl:-translate-x-full': strength < 2 }]"></div>
                        </div>
                        <div class="flex-1 rounded-full bg-[var(--md-sys-color-surface-variant)] overflow-hidden">
                            <div class="h-full w-full transition-all duration-500 origin-left"
                                 :class="[bar3Color, { 'translate-x-full rtl:-translate-x-full': strength < 3 }]"></div>
                        </div>
                    </div>

                    <!-- Requirements Checklist -->
                    <div class="mt-2 text-xs text-[var(--md-sys-color-on-surface-variant)] opacity-0 transition-opacity duration-300" :class="{ 'opacity-100': showIndicator }">
                        <div class="flex gap-3 flex-wrap">
                            <span :class="{ 'text-green-600': hasLetter }">• حروف</span>
                            <span :class="{ 'text-green-600': hasNumber }">• اعداد</span>
                            <span :class="{ 'text-green-600': hasSpecial }">• کاراکتر خاص</span>
                            <span :class="{ 'text-green-600': value.length >= 10 }">• ۱۰+ کاراکتر</span>
                        </div>
                    </div>
                ...
                <!-- Confirm Password -->
                <div class="md3-input-group group relative col-span-1">
                    <div class="relative transition-transform duration-300 focus-within:scale-[1.02]">
                        <input wire:model.lazy="password_confirmation" id="password_confirmation" required autocomplete="new-password"
                               :type="showConfirm ? 'text' : 'password'"
                               class="md3-input peer ps-14 pe-12 py-3.5 text-lg bg-[var(--md-sys-color-surface-variant)]/30 focus:bg-[var(--md-sys-color-surface-variant)]/50" placeholder=" " />
                        ...
                        <span class="material-symbols-rounded absolute top-[20px] rtl:right-4 ltr:left-4 text-[24px] text-[var(--md-sys-color-on-surface-variant)] transition-colors duration-300 peer-focus:text-[var(--md-sys-color-primary)] pointer-events-none">lock_reset</span>
