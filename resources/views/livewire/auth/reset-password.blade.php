<x-auth-card title="تنظیم رمز جدید" description="لطفاً یک رمز عبور جدید و قوی برای حساب خود تعریف کنید.">
    <x-slot:imageContent>
         {{-- Custom Reset Branding --}}
         <div class="relative group-hover:scale-105 transition-transform duration-700 ease-in-out">
            <div class="absolute inset-0 bg-gradient-to-tr from-[var(--md-sys-color-tertiary)] to-[var(--md-sys-color-primary)] opacity-30 blur-2xl rounded-full"></div>
            <div class="w-32 h-32 rounded-[2.5rem] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl border border-white/20 shadow-2xl flex items-center justify-center relative z-10">
                <span class="material-symbols-rounded text-[80px] text-[var(--md-sys-color-on-surface)] drop-shadow-2xl">encrypted</span>
            </div>
        </div>
        <div class="space-y-4 text-center relative z-10">
            <h2 class="text-3xl font-bold text-[var(--md-sys-color-on-surface)] tracking-tight drop-shadow-sm">Secure Update</h2>
            <p class="text-[var(--md-sys-color-on-surface-variant)] text-lg max-w-[250px] mx-auto leading-relaxed font-medium">
                بروزرسانی امن<br>رمز عبور حساب
            </p>
        </div>
    </x-slot:imageContent>
