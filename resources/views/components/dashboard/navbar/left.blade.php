...
<a href="{{ url('/ticketing') }}"            @mouseenter="setHover('ticketing')"            @mouseleave="clearHover()"            class="relative flex flex-col items-center justify-center py-5 md:py-6 px-2                   rounded-r-2xl rounded-l-none                   shadow-[4px_0_16px_var(--md-sys-color-primary)]/15                   transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]                   active:scale-[0.94] active:shadow-none                   cursor-pointer overflow-hidden                   lg:translate-x-0 touch-manipulation                   min-h-[80px] md:min-h-[100px]                   bg-[var(--md-sys-color-primary)]                   text-[var(--md-sys-color-on-primary)]                   hover:bg-[var(--md-sys-color-primary-container)]                   hover:text-[var(--md-sys-color-on-primary-container)]                   hover:shadow-[6px_0_24px_var(--md-sys-color-primary)]/20"            :class="{                '-translate-x-full lg:translate-x-0': !isExpanded,                'translate-x-0': isExpanded,                'hover:translate-x-2 lg:hover:translate-x-1': true            }"            :style="'transition-delay: ' + getTransitionDelay(1)">              <span class="material-symbols-rounded text-[24px] md:text-[26px] mb-2 transition-all duration-500"                   :class="{                       'scale-110 rotate-[8deg]': isHovered('ticketing'),                       'scale-100': !isHovered('ticketing')                   }"                   :style="isActive('ticketing') ? 'color: var(--md-sys-color-on-primary); filter: drop-shadow(0 0 8px var(--md-sys-color-on-primary));' : ''">support_agent</span>              <span class="[writing-mode:vertical-rl] rotate-180 text-[10px] md:text-[11px] font-bold tracking-[0.15em] leading-tight text-center uppercase opacity-95">                 پشتیبانی IT             </span>              <div x-show="isActive('ticketing')"                  x-transition:enter="transition-all duration-500 ease-out"                  x-transition:enter-start="opacity-0 scale-y-0 translate-x-2"                  x-transition:enter-end="opacity-100 scale-y-100 translate-x-0"                  class="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-12 rounded-r-full bg-[var(--md-sys-color-on-primary)] shadow-[2px_0_12px_var(--md-sys-color-on-primary)]/60"></div>              <div x-show="isHovered('ticketing') && !isActive('ticketing')"                  x-transition:enter="transition-opacity duration-300"                  x-transition:enter-start="opacity-0"                  x-transition:enter-end="opacity-100"                  class="absolute inset-0 bg-[var(--md-sys-color-primary-container)]/10 pointer-events-none"></div>         </a>
