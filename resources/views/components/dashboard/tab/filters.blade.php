...
>
    <div class="flex items-center gap-2 w-full max-w-7xl mx-auto ">
        <button
            ...
            class="h-12 px-4 sm:px-6 shrink-0 rounded-xl transition-all duration-200 relative flex items-center justify-center gap-2 font-medium text-sm border"
    ...
    <div x-show="showFilters" x-collapse class="overflow-hidden w-full max-w-7xl mx-auto">
