                        ...
                        <div class="rounded-xl p-4 border border-[var(--md-sys-color-outline-variant)]/50 bg-[var(--md-sys-color-surface-variant)]/40 hover:bg-[var(--md-sys-color-surface-variant)]/70 transition-colors">
                            ...
                            <ul class="space-y-2">
                                ...
                                <li class="rounded-xl border border-[var(--md-sys-color-outline-variant)]/40 overflow-hidden bg-[var(--md-sys-color-surface)]/70">
                                    ...
                                    <div class="px-3 pb-3 pt-1 text-[12px] leading-6 text-[var(--md-sys-color-on-surface-variant)] border-t border-[var(--md-sys-color-outline-variant)]/30 pr-8">
                                        تمام ماژول‌های سامانه شامل اعلان‌ها، فید، تقویم، گالری، گزارشات، ، FAQ، پروفایل، آنبوردینگ، مدارک، اطلاعات کاربری، فرصت‌های شغلی، پیشنهادات، تسک‌بورد، DMS، تیکت، رزرو، چت داخلی، انرژی، اختیارات، رادیو و سایر ابزارها در یادداشت‌ها پوشش داده شدند.
                                    </div>
                                </li>
                                <li class="rounded-xl border border-[var(--md-sys-color-outline-variant)]/40 overflow-hidden bg-[var(--md-sys-color-surface)]/70">
                                    <div class="w-full flex items-start gap-2 p-3 text-right">
                        ...
                        <div class="rounded-xl p-4 border border-[var(--md-sys-color-outline-variant)]/50 bg-[var(--md-sys-color-surface-variant)]/40 hover:bg-[var(--md-sys-color-surface-variant)]/70 transition-colors">
                            ...
                            <ul class="space-y-2">
                                @foreach([
                                    ...
                                    ['گزارشات + ', 'تولید گزارش PDF/سندی، اشتراک بین واحدی و دسترسی هوشمند به ابزارهای داخلی/خارجی بر اساس شبکه.'],
                                ] as [$title, $desc])
                                    <li class="rounded-xl border border-[var(--md-sys-color-outline-variant)]/40 overflow-hidden bg-[var(--md-sys-color-surface)]/70">
                                        <div class="w-full flex items-start gap-2 p-3 text-right">
                        ...
                        <div class="rounded-xl p-4 border border-[var(--md-sys-color-outline-variant)]/50 bg-[var(--md-sys-color-surface-variant)]/40 hover:bg-[var(--md-sys-color-surface-variant)]/70 transition-colors">
                            ...
                            <ul class="space-y-2">
                                @foreach([
                                    ...
                                    ['زیرساخت عملیاتی', 'پشتیبانی از تقویم سازمانی، ، گزارشات و سایر قابلیت‌های پایه برای آماده‌سازی بستر منابع انسانی.'],
