        ...
        <div class="swiper-wrapper items-center">
            ...
            <div class="swiper-slide !w-auto">
                <button type="button"
                        ...
                        class="group relative flex w-9 h-9 active:scale-95 transition-all duration-200 items-center justify-center rounded-full hover:bg-gray-50 dark:hover:bg-white/5 outline-none focus-visible:ring-2 focus-visible:ring-primary-500 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
